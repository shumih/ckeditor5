...
describe('Env', () => {
  ...
  describe('isGecko()', () => {
    it('returns true for Firefox UA strings', () => {
      ...
      expect(isGecko(toLowerCase('mozilla/5.0 (macintosh; intel mac os x 10.13; rv:62.0) gecko/20100101 firefox/62.0')))
        .to.be.true;
    });
  ...
  describe('isSafari()', () => {
    ...
    it('returns false for non-Safari UA strings', () => {
      ...
      expect(isSafari(toLowerCase('Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:65.0) Gecko/20100101 Firefox/65.0'))).to
        .be.false;
  ...
  describe('isAndroid()', () => {
    ...
    it('returns false for non-Android UA strings', () => {
      ...
      expect(isAndroid(toLowerCase('Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:65.0) Gecko/20100101 Firefox/65.0')))
        .to.be.false;

      expect(isAndroid(toLowerCase('Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko'))).to.be
        .false;
    });
    /* eslint-enable max-len */
  });
