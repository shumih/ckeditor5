...
describe('areConnectedThroughProperties()', () => {
  ...
  it('should return `true` if the first structure is deep inside the second structure', () => {
    ...
    const el2 = {
      foo: 1,
      bar: [1, 2, 3, new Map([[{}, new Set([1, 2, 3])], [undefined, new Set([Symbol('foo'), null, { x: [el1] }])]])],
    };
  ...
  it('should return `true` if the second structure is deep inside the first structure', () => {
    ...
    const el1 = {
      foo: 1,
      bar: [1, 2, 3, new Map([[{}, new Set([1, 2, 3])], [undefined, new Set([Symbol('foo'), null, { x: [el2] }])]])],
    };
  ...
  it('should return `true` if both structures have a common reference', () => {
    ...
    const el1 = {
      foo: 1,
      bar: [1, 2, 3, new Map([[{}, new Set([1, 2, 3])], [undefined, new Set([Symbol('foo'), null, { x: [foo] }])]])],
    };
  ...
  it('should return `false` if the structures is not connected #1', () => {
    ...
    const el2 = {
      foo: 1,
      bar: [1, 2, 3, new Map([[{}, new Set([1, 2, 3])], [undefined, new Set([Symbol('foo'), null, { x: [] }])]])],
    };
