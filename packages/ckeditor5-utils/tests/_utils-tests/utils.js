  ...
  describe('assertEqualMarkup()', () => {
    ...
    it('should format actual string', () => {
      try {
        ...
        expect(assertionError.actual).to.equal('<div>\n' + '  <p><span>foo</span></p>\n' + '</div>');
      }
    });
    ...
    it('should format expected string', () => {
      try {
        ...
        expect(assertionError.expected).to.equal('<div>\n' + '  <p><span>foo</span></p>\n' + '</div>');
      }
    });
    ...
    it('should format model text node with attributes as inline', () => {
      try {
        ...
        expect(assertionError.expected).to.equal('<paragraph><$text bold="true">foo</$text></paragraph>');
      }
    });
