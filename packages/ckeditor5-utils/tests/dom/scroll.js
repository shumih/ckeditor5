...
describe('scrollViewportToShowTarget()', () => {
  ...
  describe('in an iframe', () => {
    ...
    it('does not scroll the viewport when the target is fully visible', () => {
      stubRect(target, { top: 100, right: 200, bottom: 200, left: 100, width: 100, height: 100 });
      stubRect(
        targetAncestor,
        { top: 100, right: 300, bottom: 400, left: 0, width: 300, height: 300 },
        { scrollLeft: 200, scrollTop: -100 }
      );
      stubRect(iframe, { top: 200, right: 400, bottom: 400, left: 200, width: 200, height: 200 });
      stubRect(
        iframeAncestor,
    ...
    it('scrolls the viewport to show the target (above)', () => {
      ...
      stubRect(iframe, { top: 2000, right: 2000, bottom: 2500, left: 2500, width: 500, height: 500 });
      stubRect(
        iframeAncestor,
