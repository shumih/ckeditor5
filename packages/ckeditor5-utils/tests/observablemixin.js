...
describe('Observable', () => {
  ...
  describe('set()', () => {
    ...
    it('should fire the "change" event', () => {
      ...
      sinon.assert.calledWithExactly(
        spy,
        sinon.match.instanceOf(EventInfo),
        'wheels',
        4,
  ...
  describe('bind()', () => {
    ...
    describe('to()', () => {
      ...
      it('should work when no property specified #1', () => {
        ...
        assertBinding(vehicle, { color: car.color, year: undefined }, [[car, { color: 'blue', year: 1969 }]], {
          color: 'blue',
          year: undefined,
        });
      });
      ...
      it('should work for multiple properties', () => {
        ...
        assertBinding(vehicle, { color: car.color, year: car.year }, [[car, { color: 'blue', year: 1969 }]], {
          color: 'blue',
          year: 1969,
        });
      });
      ...
      it('should work when using the same property name more than once', () => {
        ...
        assertBinding(vehicle, { color: car.year, year: car.year }, [[car, { color: 'blue', year: 1969 }]], {
          color: 1969,
          year: 1969,
        });
      });
      ...
      it('should work with callback #1', () => {
        ...
        assertBinding(
          ...
          [[car1, { color: 'black', year: 1930 }], [car2, { color: 'green', year: 1950 }]],
      ...
      it('should work with callback #5', () => {
        ...
        assertBinding(
          ...
          [[car1, { hue: 'greens', year: 1930 }], [car2, { lightness: 'dark', year: 1950 }]],
      ...
      it('should work with callback #7', () => {
        ...
        assertBinding(
          ...
          [[car1, { color: 'blue', year: 2100 }], [car2, { color: 'violet', year: 1969 }]],
    ...
    describe('toMany()', () => {
      ...
      it('should not chain', () => {
        expect(car.bind('color').toMany([new Observable({ color: 'red' })], 'color', () => {})).to.be.undefined;
      });
  ...
  describe('unbind()', () => {
    ...
    it('should remove all bindings', () => {
      ...
      assertBinding(vehicle, { color: 'red', year: 2015 }, [[car, { color: 'blue', year: 1969 }]], {
        color: 'red',
        year: 2015,
      });
    });
    ...
    it('should remove bindings of certain properties, callback', () => {
      ...
      assertBinding(vehicle, { color: 'redblue' }, [[car1, { color: 'green' }], [car2, { color: 'violet' }]], {
        color: 'redblue',
      });
    });
    ...
    it('should be able to unbind two properties from a single source observable property', () => {
      ...
      assertBinding(vehicle, { color: 'red', interiorColor: 'red' }, [[car, { color: 'blue' }]], {
        color: 'red',
        interiorColor: 'red',
      });
    });
