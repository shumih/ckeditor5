  ...
  describe('changes object', () => {
    ...
    describe('insertion', () => {
      ...
      it('should diff insertion in array of objects', () => {
        ...
        expectDiff([o1, o2], [o1, o2, { baz: 3 }], [{ index: 2, type: 'insert', values: [{ baz: 3 }] }]);
      });
    ...
    describe('deletion', () => {
      ...
      it('should diff deletion in array of objects', () => {
        ...
        expectDiff([o1, o2], [o2], [{ index: 0, type: 'delete', howMany: 1 }]);
      });
    ...
    describe('replacement', () => {
      it('should diff replacement of entire text', () => {
        ...
        expectDiff(
          '12345',
          'abcd',
          [{ index: 0, type: 'insert', values: ['a', 'b', 'c', 'd'] }, { index: 4, type: 'delete', howMany: 5 }],
          false
        );
      });
      ...
      it('should diff replacement on the beginning (repetitive substring)', () => {
        ...
        expectDiff(
          '12345',
          '345345',
          [{ index: 0, type: 'insert', values: ['3', '4', '5'] }, { index: 3, type: 'delete', howMany: 2 }],
          false
        );
      });
      ...
      it('should diff replacement on the end', () => {
        ...
        expectDiff(
          '12345',
          '12ab',
          [{ index: 2, type: 'insert', values: ['a', 'b'] }, { index: 4, type: 'delete', howMany: 3 }],
          false
        );
      });
      ...
      it('should diff replacement on the end (repetitive substring)', () => {
        ...
        expectDiff(
          '12345',
          '1231234',
          [{ index: 3, type: 'insert', values: ['1', '2', '3', '4'] }, { index: 7, type: 'delete', howMany: 2 }],
          false
        );
      });
      ...
      it('should diff insertion of duplicated content', () => {
        expectDiff(
          '1234',
          '123123',
          [{ index: 3, type: 'insert', values: ['1', '2', '3'] }, { index: 6, type: 'delete', howMany: 1 }],
          false
        );
      });
      ...
      it('should diff insertion of duplicated content', () => {
        expectDiff(
          '1234',
          '13424',
          [{ index: 1, type: 'insert', values: ['3', '4', '2'] }, { index: 4, type: 'delete', howMany: 2 }],
          false
        );
      });
      ...
      it('should diff replacement in the middle (repetitive substring)', () => {
        ...
        expectDiff(
          '12345',
          '12123455',
          [{ index: 2, type: 'insert', values: ['1', '2', '3', '4', '5'] }, { index: 7, type: 'delete', howMany: 2 }],
          false
        );
      });
      ...
      it('should diff replacement of duplicated content', () => {
        ...
        expectDiff(
          '123123',
          '123333',
          [{ index: 3, type: 'insert', values: '33'.split('') }, { index: 5, type: 'delete', howMany: 2 }],
          false
        );
      });
      ...
      it('should diff replacement in array of objects', () => {
        ...
        expectDiff(
          [o1, o2],
          [o1, { baz: 3 }],
          [{ index: 1, type: 'insert', values: [{ baz: 3 }] }, { index: 2, type: 'delete', howMany: 1 }]
        );
      });
      ...
      it('should diff insertion in array of objects with comparator', () => {
        expectDiff(
          [{ text: 'foo' }, { text: 'bar' }],
          [{ text: 'foo' }, { text: 'baz' }],
          [{ index: 1, type: 'insert', values: [{ text: 'baz' }] }, { index: 2, type: 'delete', howMany: 1 }],
          true,
          (a, b) => a.text === b.text
        );
      });
      ...
      describe('with multi-byte unicode', () => {
        ...
        it('should properly replace emoji with text', () => {
          expectDiff(
            'a🙂b',
            'axb',
            [{ index: 1, type: 'insert', values: ['x'] }, { index: 2, type: 'delete', howMany: smileEmoji.length }],
            false
          );
        });
        ...
        it('should properly replace simple emoji with ZWJ sequence of it', () => {
          ...
          expectDiff('a👩b', 'a👩‍🦰b', [{ index: 3, type: 'insert', values: womanRedHairEmoji.slice(2) }]);
        });

        it('should properly replace ZWJ sequence with simple emoji (part of sequence)', () => {
          // Note that first 2 chars of both emoji are the same.
          expectDiff('a👩‍🦰b', 'a👩b', [{ index: 3, type: 'delete', howMany: 3 }]);
        });
...
function expectDiff(oldText, newText, expected, checkDiffToChangesCompatibility = true, comparator = null) {
  ...
  if (checkDiffToChangesCompatibility) {
    expect(result).to.deep.equal(
      diffToChanges(diff(oldText, newText, comparator), newText),
      'diffToChanges compatibility failed'
    );
  }
}
