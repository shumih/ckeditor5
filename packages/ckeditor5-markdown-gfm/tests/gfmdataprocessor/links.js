...
describe('GFMDataProcessor', () => {
  describe('links', () => {
    ...
    it('should not autolink inside inline code', () => {
      test('`<http://example.com/>`', '<p><code><http://example.com/></code></p>');
    });
    ...
    it('should process inline links', () => {
      test('[URL](/url/)', '<p><a href="/url/">URL</a></p>');
    });

    it('should process inline links with title', () => {
      test('[URL and title](/url/ "title")', '<p><a href="/url/" title="title">URL and title</a></p>');
    });
