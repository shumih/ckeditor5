  ...
  describe('inline styles', () => {
    ...
    it('pastes inline styles and links (no block)', () => {
      return ClassicTestEditor.create(element, {
        plugins: [Clipboard, Paragraph, Bold, Italic, Link],
      }).then(editor => {
    ...
    it('pastes inline styles and links (inside unknown block)', () => {
      return ClassicTestEditor.create(element, {
        ...
        pasteHtml(
          editor,
          '<div>x <strong>bold</strong> <i>italic</i> <a href="x">link</a> y</div>'
        );
    ...
    it('pastes inline styles and links (inside known block but on disallowed position)', () => {
      return ClassicTestEditor.create(element, {
        plugins: [Clipboard, Paragraph, BlockQuote, Bold, Italic, Link],
      }).then(editor => {
        setData(editor.model, '<paragraph>[]</paragraph>');

        pasteHtml(
          editor,
          '<blockquote>x <strong>bold</strong> <i>italic</i> <a href="x">link</a> y</blockquote>'
        );
