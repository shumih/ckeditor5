...
export function downcastInsertTable(options = {}) {
  return dispatcher =>
    dispatcher.on('insert:table', (evt, data, conversionApi) => {
      ...
      const figureElement = conversionApi.writer.createContainerElement('figure', { class: 'editor-content-table' });
...
export function downcastTableHeadingRowsChange(options = {}) {
  ...
  return dispatcher =>
    dispatcher.on('attribute:headingRows:table', (evt, data, conversionApi) => {
      const table = data.item;
      ...
      if (newRows > oldRows) {
        ...
        const rowsToMove = Array.from(table.getChildren()).filter(({ index }) =>
...
export function downcastTableHeadingColumnsChange(options = {}) {
  ...
  return dispatcher =>
    dispatcher.on('attribute:headingColumns:table', (evt, data, conversionApi) => {
      const table = data.item;
