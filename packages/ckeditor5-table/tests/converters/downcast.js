...
describe('downcast converters', () => {
  ...
  describe('downcastInsertTable()', () => {
    it('should create table with tbody', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formatTable(
          '<figure class="table">' +
            '<table>' +
            '<tbody>' +
    ...
    it('should create table with tbody and thead', () => {
      setModelData(model, modelTable([['00'], ['10']], { headingRows: 1 }));
    ...
    it('should create table with thead', () => {
      setModelData(model, modelTable([['00'], ['10']], { headingRows: 2 }));
    ...
    it('should create table with heading columns and rows', () => {
      setModelData(
        model,
        modelTable([['00', '01', '02', '03'], ['10', '11', '12', '13']], { headingColumns: 3, headingRows: 1 })
      );
    ...
    it('should create table with block content', () => {
      setModelData(model, modelTable([['<paragraph>00</paragraph><paragraph>foo</paragraph>', '01']]));
    ...
    it('should create table with block content (attribute on paragraph)', () => {
      ...
      setModelData(model, modelTable([['<paragraph alignment="right">00</paragraph>']]));
    ...
    it('should be possible to overwrite', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formatTable('<table foo="bar">' + '<tr><td><p></p></td></tr>' + '</table>')
      );
    });
    ...
    describe('headingColumns attribute', () => {
      it('should mark heading columns table cells', () => {
        setModelData(model, modelTable([['00', '01', '02'], ['10', '11', '12']], { headingColumns: 2 }));
      ...
      it('should mark heading columns table cells when one has colspan attribute', () => {
        setModelData(
          model,
          modelTable([['00', '01', '02', '03'], [{ colspan: 2, contents: '10' }, '12', '13']], { headingColumns: 3 })
        );
  ...
  describe('downcastInsertRow()', () => {
    it('should react to changed rows', () => {
      setModelData(model, modelTable([['00', '01']]));
    ...
    it('should insert row on proper index', () => {
      setModelData(model, modelTable([['00', '01'], ['21', '22'], ['31', '32']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['', ''], ['21', '22'], ['31', '32']])
      );
    });

    it('should insert row on proper index when table has heading rows defined - insert in body', () => {
      setModelData(model, modelTable([['00', '01'], ['21', '22'], ['31', '32']], { headingRows: 1 }));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['', ''], ['21', '22'], ['31', '32']], { headingRows: 1 })
      );
    });

    it('should insert row on proper index when table has heading rows defined - insert in heading', () => {
      setModelData(model, modelTable([['00', '01'], ['21', '22'], ['31', '32']], { headingRows: 2 }));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['', ''], ['21', '22'], ['31', '32']], { headingRows: 3 })
      );
    });

    it("should react to changed rows when previous rows' cells has rowspans", () => {
      setModelData(model, modelTable([[{ rowspan: 3, contents: '00' }, '01'], ['22']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([[{ rowspan: 3, contents: '00' }, '01'], ['22'], ['']])
      );
    });

    it('should properly create row headings', () => {
      setModelData(model, modelTable([[{ rowspan: 3, contents: '00' }, '01'], ['22']], { headingColumns: 1 }));
  ...
  describe('downcastInsertCell()', () => {
    ...
    it('should add tableCell on proper index in tr when previous have colspans', () => {
      setModelData(model, modelTable([[{ colspan: 2, contents: '00' }, '13']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([[{ colspan: 2, contents: '00' }, '', '13']])
      );
    });

    it('should add tableCell on proper index in tr when previous row have rowspans', () => {
      setModelData(model, modelTable([[{ rowspan: 2, contents: '00' }, '13'], ['11', '12']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([[{ rowspan: 2, contents: '00' }, '', '13'], ['', '11', '12']])
      );
    });

    it('split cell simulation - simple', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '', '01'], [{ colspan: 2, contents: '10' }, '11']])
      );
    });
    ...
    it('merge simulation - simple', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([[{ colspan: 2, contents: '00' }], ['10', '11']])
      );
    });
  ...
  describe('downcastTableHeadingColumnsChange()', () => {
    it('should work for adding heading columns', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([[{ isHeading: true, contents: '00' }, '01'], [{ isHeading: true, contents: '10' }, '11']], {
          headingColumns: 1,
        })
      );
    });
    ...
    it('should work for changing heading columns to a bigger number', () => {
      setModelData(model, modelTable([['00', '01', '02', '03'], ['10', '11', '12', '13']], { headingColumns: 1 }));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([
          [
            { isHeading: true, contents: '00' },
            { isHeading: true, contents: '01' },
            { isHeading: true, contents: '02' },
            '03',
          ],
          [
    ...
    it('should work for removing heading columns', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11']], { headingColumns: 1 }));
      const table = root.getChild(0);
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['10', '11']])
      );
    });

    it('should be possible to overwrite', () => {
      editor.conversion.attributeToAttribute({
        model: 'headingColumns',
        view: 'headingColumns',
    ...
    it('should work with adding table cells', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([
          ...
          [{ isHeading: true, contents: '11' }, { isHeading: true, contents: '' }, '12', '13'],
          [{ isHeading: true, colspan: 2, contents: '20' }, { isHeading: true, contents: '' }, '22', '23'],
        ])
      );
    });
  ...
  describe('downcastTableHeadingRowsChange()', () => {
    it('should work for adding heading rows', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11'], ['20', '21']]));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['10', '11'], ['20', '21']], { headingRows: 2 })
      );
    });

    it('should work for changing number of heading rows to a bigger number', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11'], ['20', '21']], { headingRows: 1 }));
    ...
    it('should work for changing number of heading rows to a smaller number', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11'], ['20', '21'], ['30', '31']], { headingRows: 3 }));
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['10', '11'], ['20', '21'], ['30', '31']], { headingRows: 2 })
      );
    });

    it('should work for removing heading rows', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11']], { headingRows: 2 }));
    ...
    it('should work for making heading rows without tbody', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01'], ['10', '11']], { headingRows: 2 })
      );
    });
    ...
    it('should work with adding table rows at the beginning of a table', () => {
      setModelData(model, modelTable([['00', '01'], ['10', '11']], { headingRows: 1 }));
  ...
  describe('downcastRemoveRow()', () => {
    ...
    it('should react to removed row from the beginning of a thead', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01']], { headingRows: 2 })
      );
    });
    ...
    it('should react to removed row form the end of a thead', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['10', '11']], { headingRows: 2 })
      );
    });
    ...
    it('should remove empty tbody section if a last row was removed from tbody', () => {
      ...
      expect(formatTable(getViewData(viewDocument, { withoutSelection: true }))).to.equal(
        formattedViewTable([['00', '01']], { headingRows: 1 })
      );
    });
  });
