...
describe('BalloonEditorUI', () => {
  ...
  beforeEach(() => {
    return VirtualBalloonTestEditor.create('foo', {
  ...
  describe('init()', () => {
    ...
    describe('placeholder', () => {
      ...
      it('sets placeholder from the "placeholder" attribute of a passed <textarea>', () => {
        ...
        return VirtualBalloonTestEditor.create(element, {
          plugins: [BalloonToolbar],
  ...
  describe('destroy()', () => {
    it('detaches the DOM root then destroys the UI view', () => {
      return VirtualBalloonTestEditor.create('', {
        plugins: [BalloonToolbar],
      }).then(newEditor => {
    ...
    it('restores the editor element back to its original state', () => {
      ...
      return VirtualBalloonTestEditor.create(domElement, {
        plugins: [BalloonToolbar],
      }).then(newEditor => {
        return newEditor.destroy().then(() => {
          const attributes = {};
