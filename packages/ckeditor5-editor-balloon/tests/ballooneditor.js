...
describe('BalloonEditor', () => {
  ...
  describe('constructor()', () => {
    ...
    it('should have undefined the #sourceElement if editor was initialized with data', () => {
      return BalloonEditor.create('<p>Foo.</p>', {
  ...
  describe('create()', () => {
    ...
    it('should not require config object', () => {
      ...
      return CustomBalloonEditor.create(editorElement).then(newEditor => {
  ...
  describe('create - events', () => {
    ...
    it('fires all events in the right order', () => {
      ...
      return BalloonEditor.create(editorElement, {
        ...
        expect(fired).to.deep.equal(['ready-ballooneditorui', 'ready-datacontroller', 'ready-ballooneditor']);
  ...
  describe('destroy()', () => {
    beforeEach(function() {
      return BalloonEditor.create(editorElement, { plugins: [Paragraph] }).then(newEditor => {
        editor = newEditor;
    ...
    it('sets the data back to the editor element', () => {
      ...
      return editor.destroy().then(() => {
        expect(editorElement.innerHTML).to.equal('<p>a</p><heading>b</heading>');
      });
    });
