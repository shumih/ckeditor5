...
import {
  ...
  getWidgetDomParts,
} from './widgetresize/_utils/utils';
...
describe('WidgetResize', () => {
  ...
  describe('integration (pixels)', () => {
    describe('aligned widget', () => {
      ...
      it(
        'shrinks correctly with left-bottom handler',
        generateResizeTest({
      ...
      it(
        'shrinks correctly with right-bottom handler',
        generateResizeTest({
      ...
      it(
        'shrinks correctly with left-top handler',
        generateResizeTest({
          usedHandle: 'top-left',
          movePointerBy: { x: 20, y: 10 },
          expectedWidth: '80px',
      ...
      it(
        'shrinks correctly with right-top handler',
        generateResizeTest({
      ...
      it(
        'enlarges correctly with left-bottom handler',
        generateResizeTest({
          usedHandle: 'bottom-left',
      ...
      it(
        'enlarges correctly with right-bottom handler',
        generateResizeTest({
          usedHandle: 'bottom-right',
          movePointerBy: { x: 10, y: 10 },
          expectedWidth: '120px',
      ...
      it(
        'enlarges correctly with right-bottom handler, y axis only',
        generateResizeTest({
          usedHandle: 'bottom-right',
      ...
      it(
        'enlarges correctly with right-bottom handler, x axis only',
        generateResizeTest({
          usedHandle: 'bottom-right',
      ...
      it(
        'enlarges correctly with left-top handler',
        generateResizeTest({
          usedHandle: 'top-left',
          movePointerBy: { x: -20, y: -10 },
          expectedWidth: '120px',
      ...
      it(
        'enlarges correctly with right-top handler',
        generateResizeTest({
          usedHandle: 'top-right',
          movePointerBy: { x: 20, y: 10 },
          expectedWidth: '120px',
    ...
    describe('centered widget', () => {
      ...
      it(
        'enlarges correctly with left-bottom handler, x axis only',
        generateResizeTest({
          usedHandle: 'bottom-left',
          movePointerBy: { x: -10, y: 0 },
          expectedWidth: '120px',
      ...
      it(
        'enlarges correctly with left-bottom handler, y axis only',
        generateResizeTest({
          usedHandle: 'bottom-left',
          movePointerBy: { x: 0, y: 10 },
          expectedWidth: '120px',
      ...
      it(
        'enlarges correctly with left-top handler, y axis only',
        generateResizeTest({
          usedHandle: 'top-left',
          movePointerBy: { x: 0, y: -10 },
          expectedWidth: '120px',
      ...
      it(
        'enlarges correctly with right-top handler, y axis only',
        generateResizeTest({
          usedHandle: 'top-right',
          movePointerBy: { x: 0, y: -10 },
          expectedWidth: '120px',
  ...
  describe('integration (percents)', () => {
    describe('side aligned widget', () => {
      ...
      it(
        'shrinks correctly with bottom-left handler',
        generateResizeTest({
          usedHandle: 'bottom-left',
          movePointerBy: { x: 10, y: -10 },
          expectedWidth: '22.5%',
    ...
    describe('centered widget', () => {
      ...
      it(
        'enlarges correctly with bottom-right handler',
        generateResizeTest({
          usedHandle: 'bottom-right',
  ...
  describe('attachTo()', () => {
    it('works without WidgetToolbarRepository plugin', async () => {
      ...
      const localEditor = await ClassicEditor.create(localEditorElement, {
        plugins: [WidgetResize, simpleWidgetPlugin],
      });
  ...
  function createEditor(element) {
    return ClassicEditor.create(element, {
      plugins: [ArticlePluginSet, WidgetResize, simpleWidgetPlugin],
    });
  }
