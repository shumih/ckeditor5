...
describe('HighlightUI', () => {
  ...
  describe('highlight Dropdown', () => {
    ...
    it('should have proper icons in dropdown', () => {
      ...
      expect(toolbar.items.map(item => item.icon)).to.deep.equal([
        markerIcon,
        markerIcon,
        markerIcon,
        markerIcon,
    ...
    it('should activate current option in dropdown', () => {
      ...
      expect(toolbar.items.map(item => item.isOn)).to.deep.equal([
        false,
        false,
        false,
        false,
    ...
    it('should mark as toggleable all markers and pens', () => {
      ...
      expect(toolbar.items.map(item => item.isToggleable)).to.deep.equal([
        true,
        true,
        true,
        true,
