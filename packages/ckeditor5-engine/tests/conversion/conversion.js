  ...
  describe('converters', () => {
    ...
    describe('attributeToElement', () => {
      ...
      it('config.view is an object', () => {
        ...
        testConversion(
          '<p><span class="bold">Foo</span> bar</p>',
      ...
      it('config.view is an object with upcastAlso defined', () => {
        ...
        testConversion('<p><strong>Foo</strong></p>', '<paragraph><$text bold="true">Foo</$text></paragraph>');
        ...
        testConversion('<p><span style="font-weight: 500;">Foo</span></p>', '<paragraph>Foo</paragraph>', '<p>Foo</p>');
    ...
    describe('attributeToAttribute', () => {
      ...
      it('config is an array with upcastAlso defined', () => {
        ...
        testConversion('<p class="align-right">Foo</p>', '<paragraph align="right">Foo</paragraph>');
        ...
        testConversion('<p class="align-center">Foo</p>', '<paragraph align="center">Foo</paragraph>');
      ...
      it("should not set attributes on the element's children", () => {
        ...
        conversion.elementToElement({ model: 'div', view: 'div' });
