...
describe('DowncastHelpers', () => {
  ...
  describe('attributeToAttribute()', () => {
    ...
    it('should convert insert/change/remove with attribute generating function as a parameter', () => {
      ...
      expect(viewToString(viewRoot)).to.equal(
        '<div><p class="nice fix-content">foobar</p><div class="nice"></div></div>'
      );
      ...
      expect(viewToString(viewRoot)).to.equal(
        '<div><p class="awesome fix-content">foobar</p><div class="nice"></div></div>'
      );
  ...
  describe('markerToElement()', () => {
    ...
    it('config.view is a function', () => {
      ...
      expectResult(
        'f<span data-marker="search" data-start="true"></span>o<span data-marker="search" data-start="false"></span>o'
      );
    });
    ...
    describe('collapsed range', () => {
      ...
      it('should not convert if consumable was consumed', () => {
        ...
        controller.downcastDispatcher.on(
          'addMarker:marker',
    ...
    describe('non-collapsed range', () => {
      ...
      it('should insert and remove ui element - element as a creator', () => {
        ...
        expect(viewToString(viewRoot)).to.equal(
          '<div><p>fo<span class="marker"></span>oba<span class="marker"></span>r</p></div>'
        );
  ...
  describe('markerToHighlight()', () => {
    it('should be chainable', () => {
      expect(downcastHelpers.markerToHighlight({ model: 'comment', view: { classes: 'comment' } })).to.equal(
        downcastHelpers
      );
    });
    ...
    describe('highlight', () => {
      ...
      describe('on text', () => {
        ...
        it('should correctly wrap and unwrap multiple, intersecting markers', () => {
          ...
          expect(viewToString(viewRoot)).to.equal(
            '<div>' + '<p>' + '<span class="foo">foo</span>' + '</p>' + '<p>bar</p>' + '</div>'
          );
      ...
      describe('on element', () => {
        ...
        it('should use addHighlight and removeHighlight on elements and not convert children nodes', () => {
          ...
          expect(viewToString(viewRoot)).to.equal(
            '<div>' + '<div class="highlight-class">' + 'foo' + '</div>' + '</div>'
          );
        ...
        it('should be possible to override', () => {
          ...
          expect(viewToString(viewRoot)).to.equal(
            '<div>' + '<div class="override-class">' + 'foo' + '</div>' + '</div>'
          );
...
describe('downcast converters', () => {
  ...
  describe('remove()', () => {
    ...
    it('should not remove view ui elements that are placed next to removed content', () => {
      ...
      // Remove 'b'.
      model.change(writer => {
        writer.remove(writer.createRange(writer.createPositionAt(modelRoot, 3), writer.createPositionAt(modelRoot, 4)));
      });
      ...
      // Remove 'z'.
      model.change(writer => {
        writer.remove(writer.createRange(writer.createPositionAt(modelRoot, 2), writer.createPositionAt(modelRoot, 3)));
      });
    ...
    it('should remove correct amount of text when it is split by view ui element', () => {
      ...
      model.change(writer => {
        writer.remove(writer.createRange(writer.createPositionAt(modelRoot, 2), writer.createPositionAt(modelRoot, 4)));
      });
...
describe('downcast selection converters', () => {
  ...
  describe('default converters', () => {
    describe('range selection', () => {
      it('in same container', () => {
        testSelection([1, 4], 'foobar', 'f{oob}ar');
      });

      it('in same container with unicode characters', () => {
        testSelection([2, 6], 'நிலைக்கு', 'நி{லைக்}கு');
      });

      it('in same container, over attribute', () => {
        testSelection([1, 5], 'fo<$text bold="true">ob</$text>ar', 'f{o<strong>ob</strong>a}r');
      });

      it('in same container, next to attribute', () => {
        testSelection([1, 2], 'fo<$text bold="true">ob</$text>ar', 'f{o}<strong>ob</strong>ar');
      });

      it('in same attribute', () => {
        testSelection([2, 4], 'f<$text bold="true">ooba</$text>r', 'f<strong>o{ob}a</strong>r');
      });

      it('in same attribute, selection same as attribute', () => {
        testSelection([2, 4], 'fo<$text bold="true">ob</$text>ar', 'fo{<strong>ob</strong>}ar');
      });

      it('starts in text node, ends in attribute #1', () => {
        testSelection([1, 3], 'fo<$text bold="true">ob</$text>ar', 'f{o<strong>o}b</strong>ar');
      });

      it('starts in text node, ends in attribute #2', () => {
        testSelection([1, 4], 'fo<$text bold="true">ob</$text>ar', 'f{o<strong>ob</strong>}ar');
      });

      it('starts in attribute, ends in text node', () => {
        testSelection([3, 5], 'fo<$text bold="true">ob</$text>ar', 'fo<strong>o{b</strong>a}r');
      });
      ...
      it('should convert backward selection', () => {
        testSelection([1, 3, 'backward'], 'foobar', 'f{oo}bar');
    ...
    describe('collapsed selection', () => {
      ...
      it('in container', () => {
        testSelection([1, 1], 'foobar', 'f{}oobar');
      });

      it('in attribute', () => {
        testSelection([3, 3], 'f<$text bold="true">ooba</$text>r', 'f<strong>oo{}ba</strong>r');
      });
      ...
      it('in attribute and marker', () => {
        ...
        model.change(writer => {
          const range = writer.createRange(
            ...
            writer.createPositionAt(modelRoot, 5)
          );
      ...
      it('in attribute and marker - no attribute', () => {
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal(
          '<div>f<span class="marker">o<strong>o</strong>[]<strong>b</strong>a</span>r</div>'
        );
      });
      ...
      it('in marker - using highlight descriptor creator', () => {
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal(
          '<div>f<span class="marker2">oo{}ba</span>r</div>'
        );
      });
      ...
      it('should do nothing if creator return null', () => {
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal('<div>foo{}bar</div>');
      });
      ...
      it('selection with attribute before ui element - no non-ui children', () => {
        ...
        viewRoot._appendChild([new ViewUIElement(viewDocument, 'span'), new ViewUIElement(viewDocument, 'span')]);
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal(
          '<div><span></span><span></span><strong>[]</strong></div>'
        );
      });
      ...
      it('selection with attribute before ui element - has non-ui children #1', () => {
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal(
          '<div>x<strong>[]</strong><span></span></div>'
        );
      });
      ...
      it('selection with attribute before ui element - has non-ui children #2', () => {
        ...
        // Stringify view and check if it is same as expected.
        expect(stringifyView(viewRoot, viewSelection, { showType: false })).to.equal(
          '<div><strong>x{}</strong><span></span>y</div>'
        );
      });
  ...
  describe('clean-up', () => {
    describe('convertRangeSelection', () => {
      it('should remove all ranges before adding new range', () => {
        testSelection([0, 2], 'foobar', '{fo}obar');

        testSelection([3, 5], 'foobar', 'foo{ba}r');
    ...
    describe('convertCollapsedSelection', () => {
      it('should remove all ranges before adding new range', () => {
        testSelection([2, 2], 'foobar', 'fo{}obar');

        testSelection([3, 3], 'foobar', 'foo{}bar');
    ...
    describe('clearAttributes', () => {
      it('should remove all ranges before adding new range', () => {
        testSelection([3, 3], 'foobar', 'foo<strong>[]</strong>bar', { bold: 'true' });
  ...
  describe('table cell selection converter', () => {
    ...
    it('should not be used to convert selection that is not on table cell', () => {
      testSelection([1, 5], 'f{o<$text bold="true">ob</$text>a}r', 'f{o<strong>ob</strong>a}r');
    });
