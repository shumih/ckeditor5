...
describe('Node', () => {
  let doc, root, node, one, two, three, textBA, textR, img;
  ...
  describe('should have a correct property', () => {
    ...
    it('nextSibling', () => {
      ...
      expect(textBA)
        .to.have.property('nextSibling')
        .that.deep.equals(img);
      expect(img)
        .to.have.property('nextSibling')
        .that.deep.equals(textR);
    ...
    it('previousSibling', () => {
      ...
      expect(two)
        .to.have.property('previousSibling')
        .that.equals(one);
      expect(three)
        .to.have.property('previousSibling')
        .that.equals(two);
  ...
  describe('isAttached()', () => {
    ...
    it('returns true for a node moved to graveyard', () => {
      return ModelTestEditor.create().then(editor => {
