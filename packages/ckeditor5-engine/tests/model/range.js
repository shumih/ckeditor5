...
describe('Range', () => {
  ...
  describe('getPositions()', () => {
    ...
    it('should iterate over all positions in this range', () => {
      const expectedPaths = [[1, 2], [1, 3], [2], [2, 0], [2, 3], [3], [3, 0], [3, 0, 0], [3, 0, 2]];
  ...
  describe('getTransformedByOperation()', () => {
    ...
    describe('by MergeOperation', () => {
      it('merge element with collapsed range', () => {
        ...
        const op = new MergeOperation(new Position(root, [1, 0]), 4, new Position(root, [0, 3]), gyPos, 1);
      ...
      it('merge element with collapsed range #2', () => {
        ...
        const op = new MergeOperation(new Position(root, [0, 0]), 4, new Position(root, [1, 3]), gyPos, 1);
      ...
      it('merge elements that contain elements with range boundaries', () => {
        ...
        const op = new MergeOperation(new Position(root, [1, 0]), 4, new Position(root, [0, 1]), gyPos, 1);
      ...
      it('merge at the beginning of the range', () => {
        ...
        const op = new MergeOperation(new Position(root, [2, 0]), 4, new Position(root, [1, 1]), gyPos, 1);
      ...
      it('merge at the end of the range', () => {
        ...
        const op = new MergeOperation(new Position(root, [3, 0]), 4, new Position(root, [2, 1]), gyPos, 1);
      ...
      it('range start is between merged elements #1', () => {
        ...
        const op = new MergeOperation(new Position(root, [1, 0]), 2, new Position(root, [0, 2]), gyPos, 1);
      ...
      it('range start is between merged elements #2', () => {
        ...
        const op = new MergeOperation(new Position(root, [2, 0]), 2, new Position(root, [0, 2]), gyPos, 1);
  ...
  function prepareRichRoot() {
    root._insertChild(0, [
      new Element('div', [], [new Element('h', [], new Text('first')), new Element('p', [], new Text('lorem ipsum'))]),
      new Element('p', [], new Text('foo')),
      new Element('p', [], new Text('bar')),
      new Element('div', [], [new Element('h', [], new Text('second')), new Element('p', [], new Text('lorem'))]),
    ]);
  }
});
