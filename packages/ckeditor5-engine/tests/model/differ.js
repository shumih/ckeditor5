...
describe('Differ', () => {
  ...
  describe('insert', () => {
    ...
    it('an element', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: 'image', length: 1, position }]);
      });
    });
    ...
    it('a non-empty element with attributes', () => {
      ...
      model.change(() => {
        insert(new Element('image', { src: 'foo.jpg' }, new Element('caption', null, new Text('bar'))), position);
    ...
    it('a character', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: '$text', length: 1, position }]);
      });
    });
    ...
    it('multiple characters', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: '$text', length: 3, position }]);
      });
    });
    ...
    it('multiple consecutive characters in multiple operations', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: '$text', length: 5, position }]);
      });
    });
    ...
    it('nodes between other inserted nodes', () => {
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', position: new Position(root, [0, 1]), length: 4, name: '$text' }]);
      });
    });
  ...
  describe('remove', () => {
    it('an element', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: 'paragraph', length: 1, position }]);
      });
    });
    ...
    it('a character', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: '$text', length: 1, position }]);
      });
    });
    ...
    it('multiple characters', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: '$text', length: 2, position }]);
      });
    });
    ...
    it('multiple consecutive characters in multiple operations', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: '$text', length: 3, position }]);
      });
    });
    ...
    it('all inserted nodes', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: '$text', length: 2, position: removePosition }]);
      });
    });
    ...
    it('before and after removed nodes in one operation', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: '$text', length: 3, position: removePositionB }]);
      });
    });
  ...
  describe('move', () => {
    ...
    it('reinsert removed element', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: 'listItem', length: 1, position: targetPosition }]);
      });
    });
    ...
    it('move to the same position #2', () => {
      ...
      root._appendChild([new Element('paragraph'), new Element('paragraph')]);
  ...
  describe('rename', () => {
    ...
    it('inside a new element', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: 'blockQuote', length: 1, position: new Position(root, [2]) }]);
      });
    });
  ...
  describe('attribute', () => {
    ...
    it('on an element', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'attribute', range: diffRange, attributeKey, attributeOldValue, attributeNewValue }]);
      });
    });
    ...
    it('on a character', () => {
      ...
      model.change(() => {
        ...
        expectChanges([{ type: 'attribute', range, attributeKey, attributeOldValue, attributeNewValue }]);
      });
    });
    ...
    it('attribute changes intersecting #1', () => {
      ...
      const ranges = [[0, 2, null, true, 'foo'], [1, 3, null, true, 'bar']];
    ...
    it('attribute changes intersecting #2', () => {
      ...
      // Be aware that you cannot make an intersecting changes with the same attribute key,
      // cause the value would be incorrect for the common part of the ranges.
      const ranges = [[1, 3, null, true, 'foo'], [0, 2, null, true, 'bar']];
    ...
    it('attribute changes included in an attribute change #1 - changes are reversed at the end', () => {
      ...
      const ranges = [[0, 1, null, true], [1, 2, null, true], [0, 2, true, null]];
  ...
  describe('split', () => {
    ...
    it('split an element inside a new element', () => {
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: 'blockQuote', length: 1, position: new Position(root, [0]) }]);
      });
    });
  ...
  describe('merge', () => {
    ...
    it('merge a new element', () => {
      model.change(() => {
        ...
        expectChanges([{ type: 'insert', name: '$text', length: 2, position: new Position(root, [0, 3]) }]);
      });
    });
  ...
  describe('markers', () => {
    ...
    it('add marker', () => {
      ...
      expect(differ.getMarkersToAdd()).to.deep.equal([{ name: 'name', range }]);
    ...
    it('remove marker', () => {
      ...
      expect(differ.getMarkersToRemove()).to.deep.equal([{ name: 'name', range }]);
    ...
    it("change marker's range", () => {
      ...
      expect(differ.getMarkersToAdd()).to.deep.equal([{ name: 'name', range: rangeB }]);
  ...
  describe('other cases', () => {
    ...
    it('proper filtering of changes in removed elements', () => {
      ...
      root._appendChild([
        new Element('paragraph', null, new Text('foo')),
        new Element('image'),
        new Element('blockQuote', null, [new Element('paragraph', null, new Text('text'))]),
      ]);
  ...
  describe('getChanges()', () => {
    ...
    it('should return correct changes if reset happened between getChanges() calls', () => {
      model.change(() => {
        ...
        expectChanges([{ type: 'remove', name: 'paragraph', position: removePosition, length: 1 }]);
      });
    });
  });
