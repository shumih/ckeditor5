...
describe('transform', () => {
  ...
  describe('InsertOperation', () => {
    ...
    describe('by InsertOperation', () => {
      it('target at different position: no position update', () => {
        const transformBy = new InsertOperation(new Position(root, [1, 3, 2]), [nodeC, nodeD], 0);
      ...
      it('target at offset before: increment offset', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 0]), [nodeC, nodeD], 0);
      ...
      it('target at same offset and is important: increment offset', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 2]), [nodeC, nodeD], 0);
      ...
      it('target at offset after: no position update', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 3]), [nodeC, nodeD], 0);
      ...
      it('target before node from path: increment index on path', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 1]), [nodeC, nodeD], 0);
      ...
      it('target after node from path: no position update', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 6]), [nodeC, nodeD], 0);
    ...
    describe('by RootAttributeOperation', () => {
      it('no position update', () => {
        const transformBy = new RootAttributeOperation(root, 'foo', null, 'bar', 0);
    ...
    describe('by MoveOperation', () => {
      it('range and target are different than insert position: no position update', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 3, 2]), 2, new Position(root, [2, 1]), 0);
      ...
      it('range is before insert position offset: decrement offset', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 1, new Position(root, [1, 1]), 0);
      ...
      it('range offset is after insert position offset: no position update', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 5]), 1, new Position(root, [1, 1]), 0);
      ...
      it('target offset before insert position offset: increment offset', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 1]), 2, new Position(root, [0, 2, 0]), 0);
      ...
      it('target offset after insert position offset: no position update', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 1]), 2, new Position(root, [0, 2, 5]), 0);
      ...
      it('target offset same as insert position offset and is important: increment offset', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 1]), 2, new Position(root, [0, 2, 2]), 0);
      ...
      it('range is before node from insert position path: decrement index on path', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 0]), 1, new Position(root, [1, 0]), 0);
      ...
      it('range is after node from insert position path: no position update', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 4]), 2, new Position(root, [1, 0]), 0);
      ...
      it('target before node from insert position path: increment index on path', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 0]), 2, new Position(root, [0, 0]), 0);
      ...
      it('target after node from insert position path: no position update', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 0]), 2, new Position(root, [0, 4]), 0);
      ...
      it('range has node that contains insert position: update position', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 1]), 2, new Position(root, [1, 1]), 0);
      ...
      it('range contains insert position (on same level): update position', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 4, new Position(root, [1, 0]), 0);
  ...
  describe('AttributeOperation', () => {
    ...
    describe('by InsertOperation', () => {
      it('target at offset before: increment offset', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 0]), [nodeA, nodeB], 0);
      ...
      it('target at same offset: increment offset', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 1]), [nodeA, nodeB], 0);
    ...
    describe('by MoveOperation', () => {
      it('range offset is before change range start offset: decrement offset', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 1, new Position(root, [2, 4, 1]), 0);
      ...
      it('target offset is before change range start offset: increment offset', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 4, 1]), 2, new Position(root, [0, 2, 0]), 0);
      ...
      it('range intersects on left with change range: split into two operations', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 2]), 4, new Position(root, [2, 4, 1]), 0);
      ...
      it('range intersects on right with change range: split into two operation', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 2, new Position(root, [2, 4, 1]), 0);
      ...
      it('range contains change range: update change range', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 1]), 3, new Position(root, [2, 4, 1]), 0);
      ...
      it('range is inside change range: split into two operations', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 2]), 1, new Position(root, [2, 4, 1]), 0);
      ...
      it('range is same as change range: update change range', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 1]), 3, new Position(root, [2, 4, 1]), 0);
      ...
      it('target inside change range: split into two operations', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 4, 1]), 2, new Position(root, [0, 2, 2]), 0);
      ...
      it('range intersects change range and target inside change range: split into three operations', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 2, new Position(root, [0, 2, 3]), 0);
  ...
  describe('RootAttributeOperation', () => {
    ...
    describe('by InsertOperation', () => {
      it('no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [0]), 'a', 0);
    ...
    describe('by RootAttributeOperation', () => {
      it('changes different root: no operation update', () => {
        const transformBy = new RootAttributeOperation(diffRoot, 'foo', 'abc', 'xyz', 0);
      ...
      it('changes different key: no operation update', () => {
        const transformBy = new RootAttributeOperation(root, 'abc', 'abc', 'xyz', 0);
      ...
      it('sets same value for same key: convert to NoOperation', () => {
        const transformBy = new RootAttributeOperation(root, 'foo', 'abc', 'bar', 0);
      ...
      it('sets different value for same key on same root and is important: convert to NoOperation', () => {
        const transformBy = new RootAttributeOperation(root, 'foo', 'abc', 'xyz', 0);
    ...
    describe('by MoveOperation', () => {
      it('no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [0]), 2, new Position(root, [1]), 0);
  ...
  describe('MoveOperation', () => {
    ...
    describe('by InsertOperation', () => {
      it('target at different position than move range and target: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [1, 3, 2]), [nodeA, nodeB], 0);
      ...
      it('target inside node from move range: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 2, 4, 1]), [nodeA, nodeB], 0);
      ...
      it('target at offset before range offset: increment range offset', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 2, 0]), [nodeA, nodeB], 0);
      ...
      it('target at offset after range offset: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 2, 7]), [nodeA, nodeB], 0);
      ...
      it('target before node from range start path: increment index on range start path', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 0]), [nodeA, nodeB], 0);
      ...
      it('target after node from range start path: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 3]), [nodeA, nodeB], 0);
      ...
      it('target offset before move target offset: increment target offset', () => {
        const transformBy = new InsertOperation(new Position(root, [3, 3, 2]), [nodeA, nodeB], 0);
      ...
      it('target offset after move target offset: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [3, 3, 4]), [nodeA, nodeB], 0);
      ...
      it('target before node from move target position path: increment index on move target position path', () => {
        const transformBy = new InsertOperation(new Position(root, [3, 3]), [nodeA, nodeB], 0);
      ...
      it('target after node from move target position path: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [3, 6]), [nodeA, nodeB], 0);
      ...
      it('target offset same as move target offset and is important: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [3, 3, 3]), [nodeA, nodeB], 0);
      ...
      it('target inside move range: expand range', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 2, 5]), [nodeA, nodeB], 0);
      ...
      it('target at offset same as range end boundary: no operation update', () => {
        const transformBy = new InsertOperation(new Position(root, [2, 2, 6]), [nodeA, nodeB], 0);
    ...
    describe('by AttributeOperation', () => {
      it('no operation update', () => {
        const transformBy = new AttributeOperation(new Range(sourcePosition, rangeEnd), 'abc', true, false, 0);
    ...
    describe('by MoveOperation', () => {
      it('range and target different than transforming range and target: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [1, 2]), 3, new Position(root, [4, 1, 0]), 0);
      ...
      it('target offset before transforming range start offset: increment range offset', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 0]), 0);
      ...
      it('target offset after transforming range start offset: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 7]), 0);
      ...
      it('range start offset before transforming range start offset: decrement range offset', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 2, 0]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('range start offset after transforming range start offset: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 2, 9]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('target before node from transforming range start path: increment index on range start path', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 1]), 0);
      ...
      it('target after node from transforming range start path: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 5]), 0);
      ...
      it('range before node from transforming range start path: decrement index on range start path', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 0]), 1, new Position(root, [4, 1, 0]), 0);
      ...
      it('range after node from transforming range start path: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 3]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('target offset before transforming target offset: increment target offset', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [3, 3, 0]), 0);
      ...
      it('target offset after transforming target offset: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [3, 3, 5]), 0);
      ...
      it('range offset before transforming target offset: decrement target offset', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 3, 0]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('range offset after transforming target offset: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 3, 5]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('target before node from transforming target path: increment index on target path', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [3, 1]), 0);
      ...
      it('target after node from transforming target path: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [3, 5]), 0);
      ...
      it('range before node from transforming target path: decrement index on target path', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 0]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('range after node from transforming target path: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 5]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('target inside transforming move range: split into two operations', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 5]), 0);
      ...
      it('target at start boundary of transforming move range: increment source offset', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 4]), 0);
      ...
      it('target at end boundary of transforming move range: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 6]), 0);
      ...
      it('target inside a node from transforming range: no operation update', () => {
        const transformBy = new MoveOperation(new Position(root, [4, 1, 0]), 2, new Position(root, [2, 2, 5, 1]), 0);
      ...
      it('range has node that contains transforming range: update range path', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 1]), 3, new Position(root, [4, 2]), 0);
      ...
      it('range has node that contains transforming target: update target path', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 2]), 3, new Position(root, [0, 1]), 0);
      ...
      it('target inside a node from transforming range and vice versa: reverse transform-by operation', () => {
        const transformBy = new MoveOperation(new Position(root, [3, 2]), 3, new Position(root, [2, 2, 5, 0]), 0);
      ...
      it('range is same as transforming range and is important: convert to NoOperation', () => {
        const transformBy = new MoveOperation(op.sourcePosition, op.howMany, new Position(root, [4, 1, 0]), 0);
      ...
      it('range contains transforming range and is important: convert to NoOperation', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 2, 3]), 4, new Position(root, [4, 1, 0]), 0);
      ...
      it('range contains transforming range and target and is important: update range path and target', () => {
        ...
        const transformBy = new MoveOperation(new Position(root, [2, 2, 3]), 5, new Position(root, [4, 1, 0]), 0);
      ...
      it('range intersects on left side of transforming range and is important: shrink range', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 2, 3]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('range intersects on left side of transforming range and is less important: split into two operations', () => {
        ...
        const transformBy = new MoveOperation(new Position(root, [2, 2, 3]), 2, new Position(otherRoot, [4, 1, 0]), 0);
      ...
      it('range intersects on right side of transforming range and is important: shrink range', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 2, 5]), 2, new Position(root, [4, 1, 0]), 0);
      ...
      it('range intersects on left side, target inside transforming range and is important: split into two operations', () => {
        ...
        const transformBy = new MoveOperation(new Position(root, [2, 2, 3]), 2, new Position(root, [2, 2, 6]), 0);
      ...
      it('range intersects, target inside transforming range and is important: split into two operations', () => {
        ...
        const transformBy = new MoveOperation(new Position(root, [2, 2, 5]), 4, new Position(root, [4, 1, 0]), 0);
      ...
      it('range and target inside transforming range and is important: no operation update', () => {
        ...
        const transformBy = new MoveOperation(new Position(root, [2, 2, 5]), 2, new Position(root, [2, 2, 9]), 0);
    ...
    describe('by MoveOperation to graveyard', () => {
      ...
      beforeEach(() => {
        transformBy = new MoveOperation(op.sourcePosition.clone(), op.howMany, new Position(doc.graveyard, [0]), 0);
      });
  ...
  describe('RenameOperation', () => {
    ...
    describe('by InsertOperation', () => {
      ...
      it('target after renamed element: no change', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 2, 3]), [nodeA, nodeB], 0);
      ...
      it('target before a node on path to renamed element: path update', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 1]), [nodeA, nodeB], 0);
      ...
      it('target after a node on path to renamed element: no change', () => {
        const transformBy = new InsertOperation(new Position(root, [0, 3]), [nodeA, nodeB], 0);
    ...
    describe('by AttributeOperation', () => {
      it('no operation update', () => {
        const transformBy = new AttributeOperation(
          new Range(new Position(root, [0, 2, 1]), new Position(root, [1, 3])),
          'foo',
          'bar',
          'xyz',
          0
    ...
    describe('by RenameOperation', () => {
      it('different element: no change', () => {
        const transformBy = new RenameOperation(new Position(root, [0, 2, 1]), 'foo', 'bar', 0);
      ...
      it('same element and is important: convert to NoOperation', () => {
        const transformBy = new RenameOperation(new Position(root, [0, 2, 2]), 'oldName', 'otherName', 0);
    ...
    describe('by MoveOperation', () => {
      it('moved range before renamed element: update offset', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 0]), 2, new Position(root, [2, 5]), 0);
      ...
      it('moved range before an element on path to renamed element: update path', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 0]), 2, new Position(root, [2, 5]), 0);
      ...
      it('moved range contains renamed element: update path', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 2, 1]), 3, new Position(root, [2, 5]), 0);
      ...
      it('moved range contains renamed element parent: updated path', () => {
        const transformBy = new MoveOperation(new Position(root, [0, 1]), 3, new Position(root, [2, 5]), 0);
      ...
      it('move target before renamed element: update offset', () => {
        const transformBy = new MoveOperation(new Position(root, [2, 5]), 2, new Position(root, [0, 2, 1]), 0);
  ...
  describe('MarkerOperation', () => {
    ...
    describe('by AttributeOperation', () => {
      it('no operation update', () => {
        const transformBy = new AttributeOperation(
          new Range(new Position(root, [2]), new Position(root, [11])),
          'foo',
          'bar',
          'xyz',
          0
