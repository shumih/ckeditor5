...
describe('MergeOperation', () => {
  ...
  it('should merge two nodes together', () => {
    ...
    model.applyOperation(
      new MergeOperation(new Position(root, [1, 0]), 3, new Position(root, [0, 3]), gyPos, doc.version)
    );
  ...
  it('should undo merge by applying reverse operation', () => {
    ...
    const operation = new MergeOperation(new Position(root, [1, 0]), 3, new Position(root, [0, 3]), gyPos, doc.version);
  ...
  describe('_validate()', () => {
    ...
    it('should throw an error if source position is in root', () => {
      ...
      const operation = new MergeOperation(new Position(root, [0]), 3, new Position(root, [0, 3]), gyPos, doc.version);
    ...
    it('should throw an error if target position is in root', () => {
      ...
      const operation = new MergeOperation(new Position(root, [0, 3]), 3, new Position(root, [0]), gyPos, doc.version);
