...
describe('AttributeOperation', () => {
  ...
  it('should change attribute in the middle of existing attributes', () => {
    ...
    model.applyOperation(
      new AttributeOperation(new Range(new Position(root, [0]), new Position(root, [1])), 'x', 1, 2, doc.version)
    );
  ...
  it('should remove attribute', () => {
    ...
    model.applyOperation(
      new AttributeOperation(new Range(new Position(root, [0]), new Position(root, [1])), 'x', true, null, doc.version)
    );
  ...
  it('should merge characters in node list', () => {
    ...
    model.applyOperation(
      new AttributeOperation(new Range(new Position(root, [1]), new Position(root, [3])), 'foo', 'a', 'b', doc.version)
    );
  ...
  describe('toJSON', () => {
    it('should create proper serialized object', () => {
      ...
      const op = new AttributeOperation(range, 'key', null, 'newValue', doc.version);
