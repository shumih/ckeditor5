...
describe('MoveOperation', () => {
  ...
  it('should move from one node to another', () => {
    ...
    model.applyOperation(new MoveOperation(new Position(root, [0, 0]), 1, new Position(root, [1, 0]), doc.version));
  ...
  it('should move position of children in one node backward', () => {
    ...
    model.applyOperation(new MoveOperation(new Position(root, [2]), 2, new Position(root, [1]), doc.version));
  ...
  it('should move position of children in one node forward', () => {
    ...
    model.applyOperation(new MoveOperation(new Position(root, [1]), 2, new Position(root, [4]), doc.version));
  ...
  it('should undo move node by applying reverse operation', () => {
    ...
    const operation = new MoveOperation(new Position(root, [0, 0]), 1, new Position(root, [1, 0]), doc.version);
  ...
  describe('_validate()', () => {
    it('should throw an error if number of nodes to move exceeds the number of existing nodes in given element', () => {
      ...
      const operation = new MoveOperation(new Position(root, [3]), 3, new Position(root, [1]), doc.version);
    ...
    it('should throw an error if target or source parent-element specified by position does not exist', () => {
      ...
      const operation = new MoveOperation(new Position(root, [2, 0]), 3, new Position(root, [1]), doc.version);
    ...
    it('should throw an error if operation tries to move a range between the beginning and the end of that range', () => {
      ...
      const operation = new MoveOperation(new Position(root, [1]), 3, new Position(root, [2]), doc.version);
    ...
    it('should throw an error if operation tries to move a range into a sub-tree of a node that is in that range', () => {
      ...
      const operation = new MoveOperation(new Position(root, [1]), 3, new Position(root, [2, 0, 0]), doc.version);
    ...
    it('should not throw an error if operation move a range into a sibling', () => {
      ...
      const operation = new MoveOperation(new Position(root, [1]), 1, new Position(root, [2, 0]), doc.version);
    ...
    it('should not throw when operation paths looks like incorrect but move is between different roots', () => {
      ...
      const operation = new MoveOperation(new Position(doc.graveyard, [0]), 2, new Position(root, [1, 0]), doc.version);
