...
describe('MarkerOperation', () => {
  ...
  it('should add marker to document marker collection', () => {
    ...
    model.applyOperation(new MarkerOperation('name', null, range, model.markers, true, doc.version));
  ...
  it('should update marker in document marker collection', () => {
    ...
    model.applyOperation(new MarkerOperation('name', range, range2, model.markers, true, doc.version));
  ...
  it('should remove marker from document marker collection', () => {
    ...
    model.applyOperation(new MarkerOperation('name', range, null, model.markers, true, doc.version));
  ...
  it('should not fire document markers remove event if removing non-existing range', () => {
    ...
    model.applyOperation(new MarkerOperation('name', null, null, model.markers, true, doc.version));
  ...
  it('should not fire document markers set event if newRange is same as current marker range', () => {
    ...
    model.applyOperation(new MarkerOperation('name', range, range, model.markers, false, doc.version));
