...
describe('InsertOperation', () => {
  ...
  it('should have proper type', () => {
    const op = new InsertOperation(new Position(root, [0]), new Text('x'), doc.version);
  ...
  it('should insert text node', () => {
    model.applyOperation(new InsertOperation(new Position(root, [0]), new Text('x'), doc.version));
  ...
  it('should insert set of nodes', () => {
    model.applyOperation(new InsertOperation(new Position(root, [0]), ['bar', new Element('p'), 'foo'], doc.version));
  ...
  it('should insert between existing nodes', () => {
    ...
    model.applyOperation(new InsertOperation(new Position(root, [1]), 'bar', doc.version));
  ...
  it('should insert text', () => {
    model.applyOperation(new InsertOperation(new Position(root, [0]), ['foo', new Text('x'), 'bar'], doc.version));
  ...
  it('should create a MoveOperation as a reverse', () => {
    ...
    const operation = new InsertOperation(position, ['foo', new Text('x'), 'bar'], 0);
  ...
  it('should undo insert node by applying reverse operation', () => {
    const operation = new InsertOperation(new Position(root, [0]), new Text('x'), doc.version);
  ...
  it('should undo insert set of nodes by applying reverse operation', () => {
    const operation = new InsertOperation(new Position(root, [0]), 'bar', doc.version);
