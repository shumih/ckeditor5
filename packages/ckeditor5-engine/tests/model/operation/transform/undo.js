...
describe('transform', () => {
  ...
  it('merge, merge #1', () => {
    ...
    expectClients('<blockQuote>' + '<paragraph>Foo</paragraph>' + '<paragraph>BarXyz</paragraph>' + '</blockQuote>');
  ...
  it('merge, merge #2', () => {
    ...
    expectClients('<blockQuote>' + '<paragraph>FooBar</paragraph>' + '<paragraph>Xyz</paragraph>' + '</blockQuote>');
  ...
  it('marker on closing and opening tag - remove multiple elements #1', () => {
    john.setData('<paragraph>Abc</paragraph>' + '<paragraph>Foo[</paragraph>' + '<paragraph>]Bar</paragraph>');
  ...
  it('marker on closing and opening tag + some text - merge elements + remove text', () => {
    ...
    expectClients('<paragraph>Foo<m1:start></m1:start></paragraph>' + '<paragraph>B<m1:end></m1:end>ar</paragraph>');
  });
