  ...
  describe('split', () => {
    describe('by wrap', () => {
      it('split inside wrapped element', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph>F</paragraph>' + '<paragraph>oo</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by split', () => {
      it('text in same path #1', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>o</paragraph>' + '<paragraph>o</paragraph>');
      });
      ...
      it('text in same path #2', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<paragraph>Foo</paragraph>' + '<paragraph></paragraph>');
      });
    ...
    describe('by merge', () => {
      it('element into paragraph #1', () => {
        ...
        expectClients('<paragraph>Fo</paragraph>' + '<paragraph>oBar</paragraph>');
      });
      ...
      it('element into heading', () => {
        ...
        syncClients();
        expectClients('<heading1>FooB</heading1>' + '<paragraph>ar</paragraph>');
      });
      ...
      it('element into heading with undo #2', () => {
        ...
        syncClients();
        expectClients('<heading1>Foo</heading1>' + '<paragraph>B</paragraph>' + '<paragraph>ar</paragraph>');
      });
    });
    ...
    describe('by delete', () => {
      ...
      it('text from one element', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>oo B</paragraph>');
      });
    });
    ...
    describe('by move', () => {
      it('move inside split element after split position', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>ooBa</paragraph>' + '<paragraph>r</paragraph>');
      });
      ...
      it('move operation does not really move anything', () => {
        ...
        expectClients('<paragraph>ooba</paragraph>' + '<paragraph>r</paragraph>');
      });
    });
  });
});
