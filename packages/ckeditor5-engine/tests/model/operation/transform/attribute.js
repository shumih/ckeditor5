...
describe('transform', () => {
  ...
  describe('attribute', () => {
    ...
    describe('by insert', () => {
      ...
      it('element in different path #2', () => {
        ...
        expectClients(
          '<paragraph bold="true">Foo</paragraph>' + '<paragraph>Bar</paragraph>' + '<paragraph>Abc</paragraph>'
        );
      });
    ...
    describe('by move', () => {
      it('text in different path', () => {
        ...
        expectClients('<paragraph><$text bold="true">Foo</$text></paragraph>' + '<paragraph>arB</paragraph>');
      });
      ...
      it('text in different path #2', () => {
        ...
        expectClients('<paragraph bold="true">Foo</paragraph>' + '<paragraph>arB</paragraph>');
      });
      ...
      it('remove attribute from element in different path', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>ooBar</paragraph>');
      });
    ...
    describe('by wrap', () => {
      ...
      it('element into blockQuote in different path #2', () => {
        ...
        expectClients('<paragraph bold="true">Foo</paragraph>' + '<blockQuote><paragraph>Bar</paragraph></blockQuote>');
      });
      ...
      it('element into blockQuote in same path #1', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph><$text bold="true">Foo</$text></paragraph>' + '</blockQuote>');
      });
      ...
      it('element into blockQuote in same path #2', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph bold="true">Foo</paragraph>' + '</blockQuote>');
      });
      ...
      it('remove attribute from text with 2 attributes in same path', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph>Fo<$text italic="true">o</$text></paragraph>' + '</blockQuote>');
      });
    });
    ...
    describe('by unwrap', () => {
      it('element in different path', () => {
        ...
        expectClients('<paragraph><$text bold="true">Foo</$text></paragraph>' + '<paragraph>Bar</paragraph>');
      });
      ...
      it('element in different path #2', () => {
        ...
        expectClients('<paragraph bold="true">Foo</paragraph>' + '<paragraph>Bar</paragraph>');
      });
      ...
      it('text in different path', () => {
        ...
        expectClients('<paragraph><$text bold="true">Foo</$text></paragraph>' + '<blockQuote>Bar</blockQuote>');
      });
      ...
      it('remove attribute from element in different path', () => {
        john.setData(
          '<blockQuote>[<paragraph>Foo</paragraph>]</blockQuote>' + '<paragraph bold="true">Bar</paragraph>'
        );
        kate.setData(
          '<blockQuote><paragraph>Foo</paragraph></blockQuote>' + '[<paragraph bold="true">Bar</paragraph>]'
        );
      ...
      it('remove attribute from text in different path', () => {
        ...
        expectClients('<blockQuote>Foo</blockQuote>' + '<paragraph>Bar</paragraph>');
      });
    ...
    describe('by split', () => {
      ...
      it('text in different path #2', () => {
        ...
        expectClients(
          '<paragraph bold="true">Foo</paragraph>' + '<paragraph>Ba</paragraph>' + '<paragraph>r</paragraph>'
        );
      });
      ...
      it('text in same path #1', () => {
        ...
        expectClients('<paragraph><$text bold="true">Foo</$text> B</paragraph>' + '<paragraph>ar</paragraph>');
      });
      ...
      it("text in other user's selection", () => {
        ...
        expect(
          '<paragraph><$text bold="true">Fo</$text></paragraph>' + '<paragraph><$text bold="true">o</$text></paragraph>'
        );
      });
      ...
      it("text in other user's selection #2", () => {
        ...
        expectClients('<paragraph bold="true">Foo B</paragraph>' + '<paragraph bold="true">ar</paragraph>');
      });
      ...
      it('remove attribute from element in different path', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>oo</paragraph>' + '<paragraph>Bar</paragraph>');
      });
      ...
      it('remove attribute from text in same path #1', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>oo</paragraph>');
      });
      ...
      it('remove attribute from text in same path #2', () => {
        ...
        expectClients('<paragraph>Fo</paragraph>' + '<paragraph>o</paragraph>');
      });
    ...
    describe('by remove', () => {
      it('text in different path', () => {
        ...
        expectClients('<paragraph><$text bold="true">Foo</$text></paragraph>' + '<paragraph></paragraph>');
      });
      ...
      it('remove attribute from element in different path', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>Bar</paragraph>');
      });
      ...
      it('remove attribute from text in same path #2', () => {
        ...
        expectClients('<paragraph>FzBar</paragraph>');
      });
      ...
      it('remove attribute from text with 2 attributes in same path #2', () => {
        ...
        expectClients('<paragraph>F<$text italic="true">z</$text>Bar</paragraph>');
      });
    ...
    describe('by marker', () => {
      it('in text at same path', () => {
        ...
        expectClients(
          '<paragraph><$text bold="true">Foo</$text> <m1:start></m1:start>Bar<m1:end></m1:end></paragraph>'
        );
      });
      ...
      it('in text at same path #2', () => {
        ...
        expectClients('<paragraph bold="true">' + 'Foo <m1:start></m1:start>Bar<m1:end></m1:end>' + '</paragraph>');
      });
      ...
      it('in text at same position', () => {
        ...
        expectClients(
          '<paragraph><m1:start></m1:start><$text bold="true">Foo Bar</$text><m1:end></m1:end></paragraph>'
        );
      });
      ...
      it('remove attribute from element in different path', () => {
        ...
        expectClients(
          '<paragraph><m1:start></m1:start>Foo<m1:end></m1:end></paragraph>' + '<paragraph>Bar</paragraph>'
        );
      });
  ...
  describe('by rename', () => {
    it('element in different path', () => {
      ...
      expectClients('<heading1>Foo</heading1>' + '<paragraph><$text bold="true">Ba</$text>r</paragraph>');
    });
