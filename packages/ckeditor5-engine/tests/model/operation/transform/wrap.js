  ...
  describe('wrap', () => {
    describe('by wrap', () => {
      it('element in different path', () => {
        ...
        expectClients('<blockQuote><paragraph>Foo</paragraph></blockQuote>' + '<div><paragraph>Bar</paragraph></div>');
      });
    ...
    describe('by unwrap', () => {
      ...
      it('text in different path', () => {
        ...
        expectClients('<paragraph><div>Foo</div></paragraph>' + '<blockQuote>Bar</blockQuote>');
      });
    ...
    describe('by delete', () => {
      it('text in two elements #1', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph>For</paragraph>' + '</blockQuote>');
      });
