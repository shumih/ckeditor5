  ...
  describe('remove', () => {
    ...
    describe('by wrap', () => {
      it('element in different path', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<blockQuote>' + '<paragraph>Bar</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by unwrap', () => {
      ...
      it('text in different path', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<blockQuote>Bar</blockQuote>');
      });
    ...
    describe('by split', () => {
      it('text in different path', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>B</paragraph>' + '<paragraph>ar</paragraph>');
      });
      ...
      it("text in other user's selection #2", () => {
        ...
        expectClients('<paragraph></paragraph>' + '<paragraph></paragraph>');
      });
    ...
    describe('by rename', () => {
      it('element in different path', () => {
        ...
        expectClients('<heading1>Foo</heading1>' + '<paragraph></paragraph>');
      });
