  ...
  describe('insert', () => {
    describe('by insert', () => {
      it('elements at same position #1', () => {
        ...
        expectClients('<paragraph>Abc</paragraph>' + '<paragraph>Xyz</paragraph>' + '<paragraph>Foo</paragraph>');
      });
      ...
      it('elements in same parent', () => {
        ...
        expectClients('<paragraph>Abc</paragraph>' + '<paragraph>Foo</paragraph>' + '<paragraph>Xyz</paragraph>');
      });
      ...
      it('text at different paths', () => {
        ...
        expectClients('<paragraph>AbcFoo</paragraph>' + '<paragraph>BarXyz</paragraph>');
      });
      ...
      it('text, then insert element and merge', () => {
        ...
        expectClients('<paragraph>Foo Bar</paragraph>' + '<paragraph>Abc</paragraph>');
        ...
        expectClients('<paragraph>Foo BarAbc</paragraph>' + '<paragraph>Xyz</paragraph>');
      });
    ...
    describe('by move', () => {
      it('element at different paths #1', () => {
        ...
        expectClients('<paragraph>Abc</paragraph>' + '<paragraph>Foo</paragraph>' + '<paragraph>arB</paragraph>');
      });
      ...
      it('text at different paths', () => {
        ...
        expectClients('<paragraph>AbcFoo</paragraph>' + '<paragraph>arB</paragraph>');
      });
    ...
    describe('by wrap', () => {
      it('element in same path #1', () => {
        ...
        expectClients(
          '<blockQuote>' + '<paragraph>Foo Bar</paragraph>' + '</blockQuote>' + '<paragraph>Abc</paragraph>'
        );
      });
      ...
      it('element in different paths #2', () => {
        ...
        expectClients(
          '<blockQuote>' + '<paragraph>Foo</paragraph>' + '</blockQuote>' + '<paragraph>BarAbc</paragraph>'
        );
      });
      ...
      it('element, then unwrap and split', () => {
        ...
        expectClients('<paragraph>Fo</paragraph>' + '<paragraph>o Bar</paragraph>');
      });
    ...
    describe('by split', () => {
      ...
      it('text in different paths #2', () => {
        ...
        expectClients('<paragraph>FooAbc</paragraph>' + '<paragraph>B</paragraph>' + '<paragraph>ar</paragraph>');
      });
    ...
    describe('by marker', () => {
      ...
      it('in different path #2', () => {
        ...
        expectClients(
          '<paragraph>FooAbc</paragraph>' + '<paragraph><m1:start></m1:start>Bar<m1:end></m1:end></paragraph>'
        );
      });
    ...
    describe('by rename', () => {
      it('element in different path', () => {
        ...
        expectClients('<heading1>Foo</heading1>' + '<paragraph>Bar</paragraph>' + '<paragraph>Abc</paragraph>');
      });
      ...
      it('text in different paths', () => {
        ...
        expectClients('<blockQuote>' + '<heading1>Foo</heading1>' + '</blockQuote>' + '<paragraph>BAbcar</paragraph>');
      });
    });
  });
});
