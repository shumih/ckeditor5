  ...
  describe('move', () => {
    describe('by move', () => {
      ...
      it('text in different paths #3', () => {
        ...
        expectClients('<paragraph>arF</paragraph>' + '<blockQuote>' + '<paragraph>ooB</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by wrap', () => {
      it('element in different path', () => {
        ...
        expectClients('<paragraph>ooF</paragraph>' + '<blockQuote>' + '<paragraph>Bar</paragraph>' + '</blockQuote>');
      });
      ...
      it('element in different path #2', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<blockQuote>' + '<paragraph>FooBar</paragraph>' + '</blockQuote>');
      });
      ...
      it('element in same path', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph>ooF</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by unwrap', () => {
      it('element in different path #1', () => {
        ...
        expectClients('<paragraph>ooF</paragraph>' + '<paragraph>Bar</paragraph>');
      });
      ...
      it('element in different path #2', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<paragraph>FooBar</paragraph>');
      });
      ...
      it('text in different path', () => {
        ...
        expectClients('<paragraph>ooF</paragraph>' + '<blockQuote>Bar</blockQuote>');
      });
    ...
    describe('by split', () => {
      it('text in different path #1', () => {
        ...
        expectClients('<paragraph>ooF</paragraph>' + '<paragraph>B</paragraph>' + '<paragraph>ar</paragraph>');
      });
      ...
      it('text in different path #2', () => {
        ...
        expectClients('<paragraph></paragraph>' + '<paragraph>BFoo</paragraph>' + '<paragraph>ar</paragraph>');
      });
      ...
      it('text in same path', () => {
        ...
        expectClients('<paragraph>ooF B</paragraph>' + '<paragraph>ar</paragraph>');
      });
      ...
      it('moved element', () => {
        ...
        expectClients('<paragraph>Ba</paragraph>' + '<paragraph>r</paragraph>' + '<paragraph>Foo</paragraph>');
      });
      ...
      it('inside moved text', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<paragraph>r</paragraph>' + '<paragraph>oo BaAbc</paragraph>');
      });
    });
    ...
    describe('by remove', () => {
      ...
      it('text in different paths #3', () => {
        ...
        expectClients('<paragraph>F</paragraph>' + '<blockQuote>' + '<paragraph>ooB</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by rename', () => {
      ...
      it('element in different path #2', () => {
        ...
        expectClients('<blockQuote2>' + '<paragraph>BarFoo</paragraph>' + '<paragraph></paragraph>' + '</blockQuote2>');
      });
      ...
      it('element in different path #3', () => {
        ...
        expectClients('<blockQuote>' + '<heading1></heading1>' + '<paragraph>FooBar</paragraph>' + '</blockQuote>');
      });
