  ...
  describe('merge', () => {
    describe('by merge', () => {
      ...
      it('merge to different element (wrap) with undo #2', () => {
        ...
        expectClients('<blockQuote>' + '<paragraph>Bar</paragraph>' + '</blockQuote>' + '<paragraph>Foo</paragraph>');
    ...
    describe('by split', () => {
      it('merge element which got split (the element is in blockquote) and undo', () => {
        ...
        syncClients();
        expectClients(
          '<paragraph>Foo</paragraph><blockQuote><paragraph>B</paragraph><paragraph>ar</paragraph></blockQuote>'
        );
      });
    });
  });
