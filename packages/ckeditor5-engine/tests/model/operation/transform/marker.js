  ...
  describe('marker', () => {
    ...
    describe('by move', () => {
      it('text in different path', () => {
        ...
        expectClients(
          '<paragraph><m1:start></m1:start>Foo<m1:end></m1:end></paragraph>' + '<paragraph>arB</paragraph>'
        );
      });
      ...
      it("text from other user's range #2", () => {
        ...
        expectClients(
          '<paragraph>' + '<m1:start></m1:start>ar<m1:end></m1:end>' + '</paragraph>' + '<paragraph>Foo B</paragraph>'
        );
      });
      ...
      it("text from other user's range #3", () => {
        ...
        expectClients(
          '<paragraph></paragraph>' + '<paragraph><m1:start></m1:start>Foo Bar<m1:end></m1:end></paragraph>'
        );
      });
    ...
    describe('by remove', () => {
      it('text in different path', () => {
        ...
        expectClients('<paragraph><m1:start></m1:start>Foo<m1:end></m1:end></paragraph>' + '<paragraph>r</paragraph>');
      });
    ...
    describe('by wrap', () => {
      ...
      it('element in same path', () => {
        ...
        expectClients(
          '<blockQuote>' + '<paragraph><m1:start></m1:start>Foo<m1:end></m1:end></paragraph>' + '</blockQuote>'
        );
      });
    ...
    describe('by unwrap', () => {
      ...
      it('text in different path', () => {
        ...
        expectClients(
          '<paragraph><m1:start></m1:start>Foo<m1:end></m1:end></paragraph>' + '<blockQuote>Bar</blockQuote>'
        );
      });
    ...
    describe('by split', () => {
      ...
      it("text in other user's selection", () => {
        ...
        expectClients('<paragraph><m1:start></m1:start>Fo</paragraph>' + '<paragraph>o<m1:end></m1:end></paragraph>');
      });
    });
    ...
    describe('by merge', () => {
      ...
      it('wrapped element into wrapped paragraph', () => {
        ...
        expectClients(
          '<blockQuote>' + '<paragraph><m1:start></m1:start>Foo<m1:end></m1:end> Bar</paragraph>' + '</blockQuote>'
        );
      });
    ...
    describe('by rename', () => {
      it('in different path', () => {
        ...
        expectClients('<heading1>Foo</heading1>' + '<paragraph><m1:start></m1:start>Bar<m1:end></m1:end></paragraph>');
      });
