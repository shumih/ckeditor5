  ...
  describe('rename', () => {
    ...
    describe('by split', () => {
      ...
      it("element in other user's selection", () => {
        ...
        expectClients('<heading1>F</heading1>' + '<heading1>oo</heading1>');
      });
    });
    ...
    describe('by wrap', () => {
      it('element in different path', () => {
        ...
        expectClients('<heading1>Foo</heading1>' + '<blockQuote>' + '<paragraph>Bar</paragraph>' + '</blockQuote>');
      });
    ...
    describe('by unwrap', () => {
      ...
      it('text in different path', () => {
        ...
        expectClients('<heading1>Foo</heading1>' + '<blockQuote>Bar</blockQuote>');
      });
