  ...
  describe('unwrap', () => {
    describe('by unwrap', () => {
      ...
      it('unwrap two siblings then undo', () => {
        ...
        syncClients();
        expectClients(
          '<blockQuote><paragraph>Foo</paragraph></blockQuote>' + '<blockQuote><paragraph>Bar</paragraph></blockQuote>'
        );
      });
      ...
      it('text in different path', () => {
        ...
        expectClients('<blockQuote>Foo</blockQuote>' + '<blockQuote>Bar</blockQuote>');
      });
    ...
    describe('by split', () => {
      it('unwrap, then split and undo', () => {
        ...
        expectClients('<listItem>' + '<paragraph>A</paragraph>' + '<paragraph>B</paragraph>' + '</listItem>');
        ...
        expectClients('<listItem><blockQuote><paragraph>A</paragraph><paragraph>B</paragraph></blockQuote></listItem>');
      });
    });
