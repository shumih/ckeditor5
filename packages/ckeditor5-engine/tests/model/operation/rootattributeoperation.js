...
describe('RootAttributeOperation', () => {
  ...
  describe('type', () => {
    ...
    it('should be removeRootAttribute for removing attribute', () => {
      const op = new RootAttributeOperation(root, 'key', 'oldValue', null, doc.version);

      expect(op.type).to.equal('removeRootAttribute');
    });

    it('should be changeRootAttribute for removing attribute', () => {
      const op = new RootAttributeOperation(root, 'key', 'oldValue', 'newValue', doc.version);
  ...
  it('should add attribute on the root element', () => {
    model.applyOperation(new RootAttributeOperation(root, 'isNew', null, true, doc.version));
  ...
  it('should change attribute on the root element', () => {
    ...
    model.applyOperation(new RootAttributeOperation(root, 'isNew', false, true, doc.version));
  ...
  it('should remove attribute from the root element', () => {
    ...
    model.applyOperation(new RootAttributeOperation(root, 'x', true, null, doc.version));
  ...
  it('should undo adding attribute by applying reverse operation', () => {
    const operation = new RootAttributeOperation(root, 'isNew', null, true, doc.version);
  ...
  it('should undo changing attribute by applying reverse operation', () => {
    ...
    const operation = new RootAttributeOperation(root, 'isNew', false, true, doc.version);
  ...
  it('should undo remove attribute by applying reverse operation', () => {
    ...
    const operation = new RootAttributeOperation(root, 'foo', true, null, doc.version);
  ...
  describe('_validate()', () => {
    it('should throw an error when trying to change non-root element', () => {
      ...
      expectToThrowCKEditorError(() => {
        const op = new RootAttributeOperation(child, 'foo', null, 'bar', null);
    ...
    it('should throw an error when trying to change document fragment', () => {
      expectToThrowCKEditorError(() => {
        const op = new RootAttributeOperation(new DocumentFragment(), 'foo', null, 'bar', null);
    ...
    it('should throw an error when trying to remove an attribute that does not exists', () => {
      expectToThrowCKEditorError(
        () => {
          const op = new RootAttributeOperation(root, 'foo', true, null, doc.version);
    ...
    it('should throw an error when trying to add an attribute that already exists', () => {
      ...
      expectToThrowCKEditorError(
        () => {
          const op = new RootAttributeOperation(root, 'x', null, 2, doc.version);
