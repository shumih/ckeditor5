...
describe('TextProxy', () => {
  ...
  describe('getAncestors', () => {
    ...
    it('should reverse order if parentFirst option is set to true', () => {
      expect(textProxy.getAncestors({ includeSelf: true, parentFirst: true })).to.deep.equal([
        textProxy,
        element,
        root,
      ]);
