  ...
  describe('injected behavior', () => {
    ...
    describe('selection - table scenarios', () => {
      ...
      it('should fix selection on block', () => {
        ...
        setModelData(
          model,
          '<table>' + '<tableRow><tableCell>[<paragraph>aaa</paragraph>]</tableCell></tableRow>' + '</table>'
        );
    ...
    describe('non-collapsed selection - image scenarios', () => {
      ...
      it('should not fix #1 (element selection of an object)', () => {
        model.change(writer => {
          // <paragraph>foo</paragraph>[<image><caption>xxx</caption></image>]...
          writer.setSelection(
            writer.createRange(writer.createPositionAt(modelRoot, 1), writer.createPositionAt(modelRoot, 2))
          );
        });
      ...
      it('should not fix #2 (inside a limit)', () => {
        model.change(writer => {
          ...
          // <paragraph>foo</paragraph><image><caption>[xxx]</caption></image>...
          writer.setSelection(
            writer.createRange(writer.createPositionAt(caption, 0), writer.createPositionAt(caption, 3))
          );
        });
      ...
      it('should not fix #3 (inside a limit - partial text selection)', () => {
        model.change(writer => {
          ...
          writer.setSelection(
            writer.createRange(writer.createPositionAt(caption, 0), writer.createPositionAt(caption, 2))
          );
        });
      ...
      it('should not fix #4 (inside a limit - partial text selection)', () => {
        model.change(writer => {
          ...
          writer.setSelection(
            writer.createRange(writer.createPositionAt(caption, 1), writer.createPositionAt(caption, 3))
          );
        });
      ...
      it("should not fix #5 (selection in root on non limit element that doesn't allow text)", () => {
        setModelData(model, '[<figure></figure>]');

        expect(getModelData(model)).to.equal('[<figure></figure>]');
      });
    });
    ...
    describe('non-collapsed selection - other scenarios', () => {
      it('should fix #1 (element selection of not an object)', () => {
        setModelData(
          model,
          '<paragraph>aaa</paragraph>' + '[<paragraph>bbb</paragraph>]' + '<paragraph>ccc</paragraph>'
        );
      ...
      it('should fix #4 (partial selection of not an object)', () => {
        setModelData(
          model,
          '<paragraph>aaa</paragraph>' + '<paragraph>b[bb</paragraph>]' + '<paragraph>ccc</paragraph>'
        );
      ...
      it('should fix #5 (partial selection of not an object)', () => {
        setModelData(
          model,
          '<paragraph>aaa</paragraph>' + '[<paragraph>bb]b</paragraph>' + '<paragraph>ccc</paragraph>'
        );
      ...
      it('should fix #6 (selection must not cross a limit element; starts in a root)', () => {
        ...
        setModelData(model, '<a><b><c>[</c></b></a>]');
      ...
      it('should fix #8 (selection must not cross a limit element; starts in a non-limit)', () => {
        ...
        setModelData(model, '<div>[<a><b><c>]</c></b></a></div>');
      ...
      it('should not fix #2 (inline widget selected)', () => {
        setModelData(model, '<paragraph>[<inlineWidget></inlineWidget>]</paragraph>');

        expect(getModelData(model)).to.equal('<paragraph>[<inlineWidget></inlineWidget>]</paragraph>');
      });

      it('should not fix #3 (text around inline widget)', () => {
        setModelData(model, '<paragraph>fo[o<inlineWidget></inlineWidget>b]ar</paragraph>');

        expect(getModelData(model)).to.equal('<paragraph>fo[o<inlineWidget></inlineWidget>b]ar</paragraph>');
      });
    ...
    describe('collapsed selection', () => {
      ...
      it('should fix #2 (selection in limit element & before limit+object element)', () => {
        ...
        model.change(writer => {
          ...
          writer.setSelection(writer.createRange(writer.createPositionAt(row, 0)));
        });
