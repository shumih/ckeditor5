  ...
  describe('modifySelection', () => {
    describe('unit=character', () => {
      describe('within element', () => {
        test('does nothing on empty content', '[]', '[]');

        test('does nothing on empty content (with empty element)', '<p>[]</p>', '<p>[]</p>');

        test('does nothing on empty content (backward)', '[]', '[]', { direction: 'backward' });

        test('does nothing on root boundary', '<p>foo[]</p>', '<p>foo[]</p>');

        test('does nothing on root boundary (backward)', '<p>[]foo</p>', '<p>[]foo</p>', { direction: 'backward' });

        test('extends one character forward', '<p>f[]oo</p>', '<p>f[o]o</p>');
        ...
        test('extends one character forward (non-collapsed)', '<p>f[o]obar</p>', '<p>f[oo]bar</p>');
        ...
        test('extends to element boundary', '<p>fo[]o</p>', '<p>fo[o]</p>');
        ...
        test('shrinks forward selection (to collapsed)', '<p>foo[b]ar</p>', '<p>foo[]bar</p>', {
          direction: 'backward',
        });
        ...
        test('unicode support - combining mark forward', '<p>foo[]b̂ar</p>', '<p>foo[b̂]ar</p>');
        ...
        test('unicode support - combining mark multiple', '<p>fo[]o̻̐ͩbar</p>', '<p>fo[o̻̐ͩ]bar</p>');
        ...
        test('unicode support - combining mark to the end', '<p>fo[]o̻̐ͩ</p>', '<p>fo[o̻̐ͩ]</p>');

        test('unicode support - surrogate pairs forward', '<p>[]\uD83D\uDCA9</p>', '<p>[\uD83D\uDCA9]</p>');
      ...
      describe('beyond element', () => {
        test('extends over boundary of empty elements', '<p>[]</p><p></p><p></p>', '<p>[</p><p>]</p><p></p>');
        ...
        test('extends over boundary of non-empty elements', '<p>a[]</p><p>bcd</p>', '<p>a[</p><p>]bcd</p>');
        ...
        test('extends over character after boundary', '<p>a[</p><p>]bcd</p>', '<p>a[</p><p>b]cd</p>');
        ...
        test('extends over element when next node is a text', '<p><x>a[]</x>bc</p>', '<p><x>a[</x>]bc</p>');

        test('extends over element when next node is a text - backward', '<p>ab<x>[]c</x></p>', '<p>ab[<x>]c</x></p>', {
          direction: 'backward',
        });
        ...
        test('shrinks over boundary of non-empty elements (backward)', '<p>a[</p><p>]b</p>', '<p>a[]</p><p>b</p>', {
          direction: 'backward',
        });
    ...
    describe('unit=codePoint', () => {
      ...
      test('does nothing on empty content (with empty element)', '<p>[]</p>', '<p>[]</p>', { unit: 'codePoint' });

      test('extends one user-perceived character forward - latin letters', '<p>f[]oo</p>', '<p>f[o]o</p>', {
        unit: 'codePoint',
      });
      ...
      test('unicode support - combining mark forward', '<p>foo[]b̂ar</p>', '<p>foo[b]̂ar</p>', { unit: 'codePoint' });
      ...
      test('unicode support - combining mark multiple', '<p>fo[]o̻̐ͩbar</p>', '<p>fo[o]̻̐ͩbar</p>', { unit: 'codePoint' });
    ...
    describe('unit=word', () => {
      describe('within element', () => {
        test('does nothing on empty content', '[]', '[]', { unit: 'word' });

        test('does nothing on empty content (with empty element)', '<p>[]</p>', '<p>[]</p>');

        test('does nothing on empty content (backward)', '[]', '[]', { unit: 'word', direction: 'backward' });

        test('does nothing on root boundary', '<p>foo[]</p>', '<p>foo[]</p>', { unit: 'word' });

        test('does nothing on root boundary (backward)', '<p>[]foo</p>', '<p>[]foo</p>', {
          unit: 'word',
          direction: 'backward',
        });
        ...
        test('extends whole word forward (non-collapsed)', '<p>f[o]obar</p>', '<p>f[oobar]</p>', { unit: 'word' });
        ...
        test('extends to element boundary', '<p>fo[]oo</p>', '<p>fo[oo]</p>', { unit: 'word' });
        ...
        test('expands forward selection to the word start', '<p>foo bar[b]az</p>', '<p>foo [bar]baz</p>', {
          unit: 'word',
          direction: 'backward',
        });
        ...
        test('unicode support - combining mark forward', '<p>foo[]b̂ar</p>', '<p>foo[b̂ar]</p>', { unit: 'word' });
        ...
        test('unicode support - combining mark multiple', '<p>fo[]o̻̐ͩbar</p>', '<p>fo[o̻̐ͩbar]</p>', { unit: 'word' });
        ...
        test('unicode support - combining mark to the end', '<p>f[o]o̻̐ͩ</p>', '<p>f[oo̻̐ͩ]</p>', { unit: 'word' });

        test('unicode support - surrogate pairs forward', '<p>[]foo\uD83D\uDCA9</p>', '<p>[foo\uD83D\uDCA9]</p>', {
          unit: 'word',
        });
        ...
        function testStopCharacter(stopCharacter) {
          describe(`stop character: "${stopCharacter}"`, () => {
            test('extends whole word forward', `<p>f[]oo${stopCharacter}bar</p>`, `<p>f[oo]${stopCharacter}bar</p>`, {
              unit: 'word',
            });
            ...
            it('extends whole word backward to the previous word ignoring attributes - case 1', () => {
              setData(model, `<p>foobarbaz${stopCharacter}foo<$text bold="true">bar</$text>baz[]</p>`);
            ...
            it('extends whole word backward to the previous word ignoring attributes - case 2', () => {
              setData(model, `<p>foobarbaz${stopCharacter}<$text bold="true">bar</$text>baz[]</p>`);
      ...
      describe('beyond element', () => {
        ...
        test('extends over character after boundary', '<p>a[</p><p>]bcd</p>', '<p>a[</p><p>bcd]</p>', { unit: 'word' });
    ...
    describe('objects handling', () => {
      ...
      test('extends over object elements - forward', '[<obj></obj>]<obj></obj>', '[<obj></obj><obj></obj>]');
