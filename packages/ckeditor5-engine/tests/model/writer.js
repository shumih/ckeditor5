...
describe('Writer', () => {
  ...
  describe('setAttribute() / removeAttribute()', () => {
    ...
    describe('change attribute on range', () => {
      ...
      function getRange(startIndex, endIndex) {
        return new Range(Position._createAt(root, startIndex), Position._createAt(root, endIndex));
      }
      ...
      describe('setAttribute', () => {
        ...
        it("should not check range's start position node when creating operations", () => {
          const range = new Range(new Position(root, [18, 1]), new Position(root, [19]));
        ...
        it('should not change elements attribute if range contains closing tag', () => {
          const range = new Range(new Position(root, [18, 1]), new Position(root, [21]));
        ...
        it('should not create an operation if the range contains only closing tag', () => {
          const range = new Range(new Position(root, [18, 3]), new Position(root, [19]));
  ...
  describe('merge()', () => {
    ...
    it('should correctly merge in document fragment', () => {
      const docFrag = new DocumentFragment([new Element('p', null, 'foo'), new Element('p', null, 'bar')]);
  ...
  describe('setSelection()', () => {
    ...
    beforeEach(() => {
      ...
      root = doc.createRoot();
      root._appendChild([new Element('p'), new Element('p'), new Element('p', [], new Text('foo'))]);
    });
