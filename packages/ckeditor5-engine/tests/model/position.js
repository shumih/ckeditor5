...
describe('Position', () => {
  ...
  describe('static creators', () => {
    describe('_createAt()', () => {
      ...
      it('should create positions from positions', () => {
        ...
        expect(positionCopy)
          .to.have.property('path')
          .that.deep.equals([1, 0]);
        expect(positionCopy)
          .to.have.property('root')
          .that.equals(position.root);
      ...
      it('should create positions from node and offset', () => {
        expect(Position._createAt(root, 0))
          .to.have.property('path')
          .that.deep.equals([0]);
        expect(Position._createAt(root, 1))
          .to.have.property('path')
          .that.deep.equals([1]);
        expect(Position._createAt(root, 2))
          .to.have.property('path')
          .that.deep.equals([2]);

        expect(Position._createAt(p, 0))
          .to.have.property('path')
          .that.deep.equals([0, 0]);

        expect(Position._createAt(ul, 0))
          .to.have.property('path')
          .that.deep.equals([1, 0]);
        expect(Position._createAt(ul, 1))
          .to.have.property('path')
          .that.deep.equals([1, 1]);
        expect(Position._createAt(ul, 2))
          .to.have.property('path')
          .that.deep.equals([1, 2]);

        expect(Position._createAt(li1, 0))
          .to.have.property('path')
          .that.deep.equals([1, 0, 0]);
        expect(Position._createAt(li1, 1))
          .to.have.property('path')
          .that.deep.equals([1, 0, 1]);
        expect(Position._createAt(li1, 2))
          .to.have.property('path')
          .that.deep.equals([1, 0, 2]);
        expect(Position._createAt(li1, 3))
          .to.have.property('path')
          .that.deep.equals([1, 0, 3]);
      });

      it('should create positions from node and flag', () => {
        expect(Position._createAt(root, 'end'))
          .to.have.property('path')
          .that.deep.equals([2]);

        expect(Position._createAt(p, 'before'))
          .to.have.property('path')
          .that.deep.equals([0]);
        expect(Position._createAt(a, 'before'))
          .to.have.property('path')
          .that.deep.equals([1, 1, 1]);

        expect(Position._createAt(p, 'after'))
          .to.have.property('path')
          .that.deep.equals([1]);
        expect(Position._createAt(a, 'after'))
          .to.have.property('path')
          .that.deep.equals([1, 1, 2]);

        expect(Position._createAt(ul, 'end'))
          .to.have.property('path')
          .that.deep.equals([1, 2]);
      });

      it('should set stickiness (if not cloning other position)', () => {
        expect(Position._createAt(root, 'end', 'toPrevious'))
          .to.have.property('stickiness')
          .that.equals('toPrevious');
      });
    ...
    describe('_createBefore()', () => {
      it('should create positions before elements', () => {
        expect(Position._createBefore(p))
          .to.have.property('path')
          .that.deep.equals([0]);

        expect(Position._createBefore(ul))
          .to.have.property('path')
          .that.deep.equals([1]);

        expect(Position._createBefore(li1))
          .to.have.property('path')
          .that.deep.equals([1, 0]);

        expect(Position._createBefore(f))
          .to.have.property('path')
          .that.deep.equals([1, 0, 0]);
        expect(Position._createBefore(o))
          .to.have.property('path')
          .that.deep.equals([1, 0, 1]);
        expect(Position._createBefore(z))
          .to.have.property('path')
          .that.deep.equals([1, 0, 2]);

        expect(Position._createBefore(li2))
          .to.have.property('path')
          .that.deep.equals([1, 1]);

        expect(Position._createBefore(b))
          .to.have.property('path')
          .that.deep.equals([1, 1, 0]);
        expect(Position._createBefore(a))
          .to.have.property('path')
          .that.deep.equals([1, 1, 1]);
        expect(Position._createBefore(r))
          .to.have.property('path')
          .that.deep.equals([1, 1, 2]);
      });

      it('should set stickiness', () => {
        expect(Position._createBefore(p, 'toPrevious'))
          .to.have.property('stickiness')
          .that.equals('toPrevious');
      });
    ...
    describe('_createAfter()', () => {
      it('should create positions after elements', () => {
        expect(Position._createAfter(p))
          .to.have.property('path')
          .that.deep.equals([1]);

        expect(Position._createAfter(ul))
          .to.have.property('path')
          .that.deep.equals([2]);

        expect(Position._createAfter(li1))
          .to.have.property('path')
          .that.deep.equals([1, 1]);

        expect(Position._createAfter(f))
          .to.have.property('path')
          .that.deep.equals([1, 0, 1]);
        expect(Position._createAfter(o))
          .to.have.property('path')
          .that.deep.equals([1, 0, 2]);
        expect(Position._createAfter(z))
          .to.have.property('path')
          .that.deep.equals([1, 0, 3]);

        expect(Position._createAfter(li2))
          .to.have.property('path')
          .that.deep.equals([1, 2]);

        expect(Position._createAfter(b))
          .to.have.property('path')
          .that.deep.equals([1, 1, 1]);
        expect(Position._createAfter(a))
          .to.have.property('path')
          .that.deep.equals([1, 1, 2]);
        expect(Position._createAfter(r))
          .to.have.property('path')
          .that.deep.equals([1, 1, 3]);
      });

      it('should set stickiness', () => {
        expect(Position._createAfter(p, 'toPrevious'))
          .to.have.property('stickiness')
          .that.equals('toPrevious');
      });
  ...
  describe('#parent', () => {
    it('should have parent', () => {
      expect(new Position(root, [0]))
        .to.have.property('parent')
        .that.equals(root);
      expect(new Position(root, [1]))
        .to.have.property('parent')
        .that.equals(root);
      expect(new Position(root, [2]))
        .to.have.property('parent')
        .that.equals(root);

      expect(new Position(root, [0, 0]))
        .to.have.property('parent')
        .that.equals(p);

      expect(new Position(root, [1, 0]))
        .to.have.property('parent')
        .that.equals(ul);
      expect(new Position(root, [1, 1]))
        .to.have.property('parent')
        .that.equals(ul);
      expect(new Position(root, [1, 2]))
        .to.have.property('parent')
        .that.equals(ul);

      expect(new Position(root, [1, 0, 0]))
        .to.have.property('parent')
        .that.equals(li1);
      expect(new Position(root, [1, 0, 1]))
        .to.have.property('parent')
        .that.equals(li1);
      expect(new Position(root, [1, 0, 2]))
        .to.have.property('parent')
        .that.equals(li1);
      expect(new Position(root, [1, 0, 3]))
        .to.have.property('parent')
        .that.equals(li1);
    });
  ...
  describe('getTransformedByOperation()', () => {
    ...
    describe('by MarkerOperation', () => {
      it('nothing should change', () => {
        const op = new MarkerOperation(
          'marker',
          null,
          new Range(Position._createAt(root, 1), Position._createAt(root, 6)),
          model.markers,
          true,
          1
        );
    ...
    describe('by MoveOperation', () => {
      it('should use _getTransformedByMove', () => {
        ...
        expect(pos._getTransformedByMove.calledWithExactly(op.sourcePosition, op.targetPosition, op.howMany)).to.be
          .true;
      });
    });
    ...
    describe('by MergeOperation', () => {
      ...
      it('position is before merged element', () => {
        const op = new MergeOperation(
          new Position(root, [3, 2, 0]),
          3,
          new Position(root, [3, 1, 2]),
          new Position(doc.graveyard, [0]),
          1
        );
      ...
      it('position is after merged element', () => {
        const op = new MergeOperation(
          new Position(root, [3, 1, 0]),
          3,
          new Position(root, [3, 0, 2]),
          new Position(doc.graveyard, [0]),
          1
        );
  ...
  describe('_getTransformedByInsertion()', () => {
    ...
    it(
      'should not update path if insertion position parent is a node from that path and offset is ' +
  ...
  describe('_getTransformedByDeletion()', () => {
    ...
    it(
      'should not update path if deletion position parent is a node from that path and ' +
