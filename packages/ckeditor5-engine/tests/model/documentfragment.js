...
describe('DocumentFragment', () => {
  describe('constructor()', () => {
    ...
    it('should create document fragment with children', () => {
      ...
      expect(frag.getChild(0))
        .to.have.property('data')
        .that.equals('xx');
      expect(frag.getChild(1))
        .to.have.property('name')
        .that.equals('p');
      expect(frag.getChild(2))
        .to.have.property('data')
        .that.equals('yy');
    });
  ...
  describe('toJSON', () => {
    ...
    it('should serialize document fragment with children', () => {
      ...
      expect(frag.toJSON()).to.deep.equal([
        ...
        {
          name: 'two',
          children: [{ data: 'ba' }, { name: 'img' }, { data: 'r' }],
        },
        { name: 'three' },
      ]);
    });
  ...
  describe('getNodeByPath', () => {
    ...
    it('should return a descendant of this node', () => {
      ...
      const element = new Element('elem', [], [new Element('elem', [], [foo, image])]);
    ...
    it('works fine with offsets', () => {
      ...
      const bold = new Element('b', [], [bar]);
      const paragraph = new Element('paragraph', [], [foo, bold, bom]);
      const frag = new DocumentFragment([abc, paragraph, xyz]);
