...
describe('TreeWalker', () => {
  let model, doc, root, img1, paragraph, ba, r, img2, x, rootBeginning, rootEnding;
  ...
  describe('iterate from start position `startPosition`', () => {
    ...
    it('should start iterating at the startPosition witch is not a root bound, going backward', () => {
      const expected = [{ type: 'elementStart', item: img1 }, { type: 'elementEnd', item: img1 }];
  ...
  describe('iterate omitting child nodes and elementEnd `shallow`', () => {
    ...
    beforeEach(() => {
      expected = [{ type: 'elementStart', item: img1 }, { type: 'elementStart', item: paragraph }];
    });
