...
describe('MutationObserver', () => {
  ...
  beforeEach(() => {
    ...
    domRoot.innerHTML =
      '<div contenteditable="true" id="main"></div><div contenteditable="true" id="additional"></div>';
  ...
  it('should be able to observe multiple roots', () => {
    ...
    viewDocument
      .getRoot('additional')
      ._appendChild(parse('<container:p>foo</container:p><container:p>bar</container:p>'));
