    ...
    describe('it should clear whitespaces', () => {
      it('at the beginning of block element', () => {
        const domDiv = createElement(document, 'div', {}, [
          ...
          createElement(document, 'p', {}, [document.createTextNode(' foo')]),
          createElement(document, 'p', {}, [document.createTextNode(' foo')]),
        ]);
      ...
      it('but preserve all except " \\n\\r\\t"', () => {
        ...
        expect(viewDiv.childCount).to.equal(2);
        expect(viewDiv.getChild(0).getChild(0).data).to.equal(
          'x\fx\vx\u00a0x\u1680x\u2000x\u200ax\u2028x\u2029x\u202fx\u205fx\u3000x\ufeffx'
        );
      ...
      it('after a <br> – when text after that <br> is nested', () => {
        const domP = createElement(document, 'p', {}, [
          document.createTextNode('foo'),
          createElement(document, 'br'),
          createElement(document, 'b', {}, [document.createTextNode(' bar')]),
        ]);
      ...
      it('multiple consecutive whitespaces changed to one', () => {
        const domDiv = createElement(document, 'div', {}, [
          createElement(document, 'p', {}, [document.createTextNode('             f    o  o')]),
          createElement(document, 'p', {}, [document.createTextNode('fo  o   ')]),
        ]);
      ...
      it('not in preformatted blocks', () => {
        const domDiv = createElement(document, 'div', {}, [
          createElement(document, 'pre', {}, [document.createTextNode('   foo\n   foo  ')]),
        ]);
      ...
      it('not in span between two words (space)', () => {
        const domDiv = createElement(document, 'div', {}, [
          ...
          createElement(document, 'span', {}, [document.createTextNode(' ')]),
          document.createTextNode('word'),
        ]);
      ...
      it("not in a Chrome's paste-like content", () => {
        ...
        const domDiv = createElement(document, 'div', {}, [
          ...
          createElement(document, 'a', {}, [document.createTextNode('word')]),
        ]);
      ...
      it('not before a <br>', () => {
        const domP = createElement(document, 'p', {}, [document.createTextNode('foo '), createElement(document, 'br')]);
      ...
      it('not before a <br> – when text before that <br> is nested', () => {
        const domP = createElement(document, 'p', {}, [
          createElement(document, 'b', {}, [document.createTextNode('foo ')]),
          createElement(document, 'br'),
        ]);
