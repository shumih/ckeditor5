  ...
  describe('unwrap()', () => {
    ...
    it('should throw error when element is not instance of AttributeElement', () => {
      const container = new ContainerElement(
        ...
        'p',
        null,
        new AttributeElement(document, 'b', null, new Text('foo'))
      );
      const range = new Range(new Position(container, 0), new Position(container, 1));
    ...
    it('should throw error when range placed in two containers', () => {
      ...
      const range = new Range(new Position(container1, 0), new Position(container2, 1));
    ...
    it('should merge unwrapped nodes #4', () => {
      ...
      const attribute = '<attribute:b view-priority="1"></attribute:b>';
      const result =
        '<container:p>' + 'foo' + '<attribute:u view-priority="1">bar{baz}qux</attribute:u>' + '</container:p>';
