  ...
  describe('breakAttributes()', () => {
    ...
    describe('break position', () => {
      ...
      function testBreakAttributes(input, expected) {
        ...
        expect(
          stringify(view.root, newPosition, {
            showType: true,
            showPriority: true,
          })
        ).to.equal(expected);
      ...
      it('should not break text nodes if they are not in attribute elements - middle', () => {
        testBreakAttributes('<container:p>foo{}bar</container:p>', '<container:p>foo{}bar</container:p>');
      });

      it('should not break text nodes if they are not in attribute elements - beginning', () => {
        testBreakAttributes('<container:p>{}foobar</container:p>', '<container:p>{}foobar</container:p>');
      });
      ...
      it('should not split text directly in document fragment', () => {
        testBreakAttributes('foo{}bar', 'foo{}bar');
      });
    });
    ...
    describe('break range', () => {
      ...
      it('should throw when range placed in two containers', () => {
        ...
        expectToThrowCKEditorError(
          ...
          'view-writer-invalid-range-container',
          document
        );
      });
      ...
      it('should not break text nodes if they are not in attribute elements', () => {
        testBreak('<container:p>foo{}bar</container:p>', '<container:p>foo{}bar</container:p>');
      });
