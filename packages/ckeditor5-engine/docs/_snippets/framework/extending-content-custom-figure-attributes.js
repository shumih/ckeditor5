...
function setupCustomAttributeConversion(viewElementName, modelElementName, viewAttribute, editor) {
  ...
  editor.conversion
    .for('downcast')
    .add(downcastAttribute(modelElementName, viewElementName, viewAttribute, modelAttribute));
}
...
ClassicEditor.create(document.querySelector('#snippet-custom-figure-attributes'), {
