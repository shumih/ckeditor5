...
function highlightText(highlightDescriptor) {
  return (evt, data, conversionApi) => {
    ...
    if (
      !(data.item instanceof ModelSelection || data.item instanceof DocumentSelection) &&
...
function prepareDescriptor(highlightDescriptor, data, conversionApi) {
  ...
  const descriptor =
    typeof highlightDescriptor == 'function' ? highlightDescriptor(data, conversionApi) : highlightDescriptor;
