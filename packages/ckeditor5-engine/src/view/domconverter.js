...
export default class DomConverter {
  ...
  *domChildrenToView(domElement, options = {}) {
  ...
  mapDomToView(domElementOrDocumentFragment) {
    return (
      this.getParentUIElement(domElementOrDocumentFragment) || this._domToViewMapping.get(domElementOrDocumentFragment)
    );
  }
  ...
  isDomSelectionCorrect(domSelection) {
    return (
      this._isDomSelectionPositionCorrect(domSelection.anchorNode, domSelection.anchorOffset) &&
