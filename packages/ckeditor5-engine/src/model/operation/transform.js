      ...
      case MarkerOperation: {
        ...
        switch (opB.constructor) {
          case MoveOperation: {
            ...
            const affectedLeft =
              movedRange.containsPosition(markerRange.start) || movedRange.start.isEqual(markerRange.start);

            const affectedRight =
              movedRange.containsPosition(markerRange.end) || movedRange.end.isEqual(markerRange.end);
...
setTransformation(MergeOperation, MergeOperation, (a, b, context) => {
  ...
  if (
    ...
    !context.bWasUndone &&
    context.abRelation != 'splitAtSource'
  ) {
...
setTransformation(MoveOperation, SplitOperation, (a, b, context) => {
  ...
  if (
    ...
    !b.graveyardPosition ||
    context.abRelation == 'moveTargetAfter'
  ) {
  ...
  if (b.graveyardPosition) {
    const movesGraveyardElement =
      moveRange.start.isEqual(b.graveyardPosition) || moveRange.containsPosition(b.graveyardPosition);
...
setTransformation(SplitOperation, MoveOperation, (a, b, context) => {
  ...
  if (a.graveyardPosition) {
    ...
    const gyElementMoved =
      rangeToMove.start.isEqual(a.graveyardPosition) || rangeToMove.containsPosition(a.graveyardPosition);
