...
describe('ClassicEditorUI', () => {
  ...
  describe('init()', () => {
    ...
    describe('editable', () => {
      ...
      it('binds view.editable#isFocused', () => {
        assertBinding(view.editable, { isFocused: false }, [[ui.focusTracker, { isFocused: true }]], {
          isFocused: true,
        });
      });
    ...
    describe('placeholder', () => {
      it('sets placeholder from editor.config.placeholder', () => {
        return VirtualClassicTestEditor.create('foo', {
      ...
      it('sets placeholder from the "placeholder" attribute of a passed <textarea>', () => {
        ...
        return VirtualClassicTestEditor.create(element, {
          extraPlugins: [Paragraph],
        }).then(newEditor => {
          const firstChild = newEditor.editing.view.document.getRoot().getChild(0);
    ...
    it('initializes keyboard navigation between view#toolbar and view#editable', () => {
      return VirtualClassicTestEditor.create('').then(editor => {
        const ui = editor.ui;
        const view = ui.view;
  ...
  describe('destroy()', () => {
    it('detaches the DOM root then destroys the UI view', () => {
      return VirtualClassicTestEditor.create('').then(newEditor => {
    ...
    it('restores the editor element back to its original state', () => {
      ...
      return VirtualClassicTestEditor.create(domElement).then(newEditor => {
        return newEditor.destroy().then(() => {
          const attributes = {};
