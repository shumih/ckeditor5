...
describe('ClassicEditor', () => {
  ...
  describe('create()', () => {
    ...
    it('should not require config object', () => {
      ...
      return CustomClassicEditor.create(editorElement).then(newEditor => {
        expect(newEditor.getData()).to.equal('<p><strong>foo</strong> bar</p>');
    ...
    it('should have undefined the #sourceElement if editor was initialized with data', () => {
      return ClassicEditor.create('<p>Foo.</p>', {
        plugins: [Paragraph, Bold],
      }).then(newEditor => {
  ...
  describe('create - events', () => {
    ...
    it('fires all events in the right order', () => {
      ...
      return ClassicEditor.create(editorElement, {
        ...
        expect(fired).to.deep.equal(['ready-classiceditorui', 'ready-datacontroller', 'ready-classiceditor']);
  ...
  describe('destroy', () => {
    beforeEach(function() {
      return ClassicEditor.create(editorElement, { plugins: [Paragraph] }).then(newEditor => {
        editor = newEditor;
      });
    });
