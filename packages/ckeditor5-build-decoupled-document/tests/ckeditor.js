...
describe('DecoupledEditor build', () => {
  ...
  describe('editor with data', () => {
    ...
    it('does not define the UI DOM structure', () => {
      return DecoupledEditor.create(editorData).then(newEditor => {
  ...
  describe('editor with editable element', () => {
    ...
    it('uses the provided editable element', () => {
      return DecoupledEditor.create(editorElement).then(newEditor => {
  ...
  function test(getEditorDataOrElement) {
    describe('create()', () => {
      beforeEach(() => {
        return DecoupledEditor.create(getEditorDataOrElement()).then(newEditor => {
          editor = newEditor;
        });
      });
