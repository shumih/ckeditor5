...
describe('AutoMediaEmbed - integration', () => {
  ...
  describe('use fake timers', () => {
    ...
    it('replaces pasted text with media element after 100ms', () => {
      ...
      expect(getData(editor.model)).to.equal('<paragraph>https://www.youtube.com/watch?v=H08tGjXNHO4[]</paragraph>');

      clock.tick(100);

      expect(getData(editor.model)).to.equal('[<media url="https://www.youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('works for a full URL (https without "wwww" sub-domain)', () => {
      ...
      expect(getData(editor.model)).to.equal('[<media url="https://youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('works for a full URL (http + "www" sub-domain)', () => {
      ...
      expect(getData(editor.model)).to.equal('[<media url="http://www.youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('works for a full URL (http without "wwww" sub-domain)', () => {
      ...
      expect(getData(editor.model)).to.equal('[<media url="http://youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('works for a URL without protocol (with "www" sub-domain)', () => {
      ...
      expect(getData(editor.model)).to.equal('[<media url="www.youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('works for a URL without protocol (without "www" sub-domain)', () => {
      ...
      expect(getData(editor.model)).to.equal('[<media url="youtube.com/watch?v=H08tGjXNHO4"></media>]');
    });
    ...
    it('does nothing if a URL is invalid', () => {
      ...
      expect(getData(editor.model)).to.equal('<paragraph>https://youtube.com[]</paragraph>');
    });
    ...
    it('does nothing if a URL is invalid (space inside URL)', () => {
      ...
      expect(getData(editor.model)).to.equal('<paragraph>youtube.com/watch?v=H08tGjXNHO4&param=foo bar[]</paragraph>');
    });
