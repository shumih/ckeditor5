...
describe('Paragraph feature', () => {
  ...
  beforeEach(() => {
    return VirtualTestEditor.create({ plugins: [Paragraph] }).then(newEditor => {
      editor = newEditor;
      model = editor.model;
      doc = model.document;
      root = doc.getRoot();
  ...
  describe('data pipeline conversions', () => {
    ...
    it('should convert multiple paragraphs', () => {
      ...
      expect(getModelData(model, { withoutSelection: true })).to.equal(
        '<paragraph>foo</paragraph><paragraph>baz</paragraph>'
      );
    ...
    describe('generic text converter (text autoparagraphing)', () => {
      ...
      it('should not autoparagraph text (in clipboard holder)', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('foo');
      });
      ...
      it('should autoparagraph text next to allowed element', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal(
          '<heading1>foo</heading1><paragraph>bar</paragraph><paragraph>bom</paragraph>'
        );
      });
      ...
      it('should autoparagraph text inside converted container', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal(
          '<div><paragraph>foo</paragraph></div>' + '<div><paragraph>bom</paragraph><paragraph>bim</paragraph></div>'
        );
      });
      ...
      it('should autoparagraph text inside disallowed element next to allowed element', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('<heading1>foo</heading1><paragraph>bar</paragraph>');
      });
      ...
      it('should not autoparagraph text in disallowed element', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('<heading1>foobar</heading1>');
      });
      ...
      describe('should not strip attribute elements when autoparagraphing texts', () => {
        ...
        it('inside converted element', () => {
          ...
          expect(stringifyModel(modelFragment)).to.equal(
            '<blockQuote><paragraph>foo<$text bold="true">bar</$text>bom</paragraph></blockQuote>'
          );
        });
        ...
        it('inside paragraph-like element', () => {
          ...
          expect(stringifyModel(modelFragment)).to.equal(
            '<paragraph>foo</paragraph><paragraph><$text bold="true">bar</$text>bom</paragraph>'
          );
        });
      });
    });
    ...
    describe('generic block converter (paragraph-like element handling)', () => {
      it('should convert h1+h2', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('<paragraph>foo</paragraph><paragraph>bar</paragraph>');
      });
      ...
      it('should not convert h1+h2 (in a context which does not allow paragraphs)', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('<div>bom</div>');
      });
      ...
      it('should convert ul>li>p,text', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal('<paragraph>a</paragraph><paragraph>b</paragraph>');
      });
      ...
      it('should convert td', () => {
        ...
        expect(stringifyModel(modelFragment)).to.equal(
          '<paragraph>a</paragraph><paragraph>b</paragraph><paragraph>c</paragraph><paragraph>d</paragraph>'
        );
      });
