...
describe('LinkCommand', () => {
  ...
  describe('execute()', () => {
    describe('non-collapsed selection', () => {
      ...
      it(
        'should overwrite `linkHref` attribute of selected text only, ' +
      ...
      it(
        'should overwrite `linkHref` attribute of selected text only, when selection end inside text with `linkHref` ' +
          'attribute',
        () => {
      ...
      it('should set `linkHref` attribute to selected text when text is split by $block element', () => {
        ...
        expect(getData(model)).to.equal(
          '<p>f[<$text linkHref="url">oo</$text></p><p><$text linkHref="url">ba</$text>]r</p>'
        );
        expect(command.value).to.equal('url');
      });
      ...
      it('should set `linkHref` attribute only to allowed elements and omit disallowed', () => {
        ...
        expect(getData(model)).to.equal(
          '<p>f[<$text linkHref="url">oo</$text><img></img><$text linkHref="url">ba</$text>]r</p>'
        );
        expect(command.value).to.equal('url');
      });
    });
  ...
  describe('manual decorators', () => {
    ...
    describe('collapsed selection', () => {
      it('should insert additional attributes to link when it is created', () => {
        ...
        expect(getData(model)).to.equal('foo[<$text linkHref="url" linkIsBar="true" linkIsFoo="true">url</$text>]bar');
      });
      ...
      it('should add additional attributes to link when link is modified', () => {
        ...
        expect(getData(model)).to.equal('f[<$text linkHref="url" linkIsBar="true" linkIsFoo="true">ooba</$text>]r');
      });
