...
describe('UnlinkCommand', () => {
  ...
  describe('execute()', () => {
    ...
    describe('collapsed selection', () => {
      ...
      it(
        'should remove `linkHref` attribute from selection siblings with the same attribute value and do not modify ' +
          'other attributes',
        () => {
          setData(
            model,
          ...
          expect(getData(model)).to.equal(
            '<$text linkHref="other url">fo</$text>' + 'o[]b' + '<$text linkHref="other url">ar</$text>'
          );
        }
      );

      it(
        'should do nothing with nodes with the same `linkHref` value when there is a node with different value `linkHref` ' +
          'attribute between',
        () => {
          setData(
            model,
      ...
      it(
        'should remove `linkHref` attribute from selection siblings with the same attribute value ' +
        ...
        () => {
          ...
          expect(getData(model)).to.equal(
            'f' + '<$text bold="true">o</$text>' + 'o[]b' + '<$text bold="true">a</$text>' + 'r'
          );
        }
      );
      ...
      it('should remove `linkHref` attribute from selection siblings only in the same parent as selection parent', () => {
        ...
        expect(getData(model)).to.equal(
          '<p><$text linkHref="url">bar</$text></p>' + '<p>fo[]o</p>' + '<p><$text linkHref="url">bar</$text></p>'
        );
      });
      ...
      it(
        'should remove `linkHref` attribute from selection siblings on the left side when selection is between two elements with ' +
