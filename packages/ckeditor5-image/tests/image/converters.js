...
import { viewFigureToModel, modelToViewAttributeConverter } from '../../src/image/converters';
...
describe('Image converters', () => {
  ...
  describe('viewFigureToModel', () => {
    ...
    it('should split parent element when image is not allowed - in the middle', () => {
      ...
      editor.setData(
        '<div>' + 'abc' + '<figure class="image">' + '<img src="foo.jpg"/>' + '</figure>' + 'def' + '</div>'
      );
    ...
    it('should split parent element when image is not allowed - at the end', () => {
      ...
      editor.setData('<div>' + 'abc' + '<figure class="image">' + '<img src="foo.jpg"/>' + '</figure>' + '</div>');
    ...
    it('should split parent element when image is not allowed - at the beginning', () => {
      ...
      editor.setData('<div>' + '<figure class="image">' + '<img src="foo.jpg"/>' + '</figure>' + 'def' + '</div>');
