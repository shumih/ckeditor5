...
describe('InlineEditor', () => {
  ...
  describe('create()', () => {
    ...
    it('should not require config object', () => {
      ...
      return CustomInlineEditor.create(editorElement).then(newEditor => {
  ...
  describe('create - events', () => {
    ...
    it('fires all events in the right order', () => {
      ...
      return InlineEditor.create(editorElement, {
        ...
        expect(fired).to.deep.equal(['ready-inlineeditorui', 'ready-datacontroller', 'ready-inlineeditor']);
  ...
  describe('destroy', () => {
    beforeEach(function() {
      return InlineEditor.create(editorElement, { plugins: [Paragraph] }).then(newEditor => {
        editor = newEditor;
    ...
    it('should not throw an error if editor was initialized with the data', () => {
      return InlineEditor.create('<p>Foo.</p>', {
        plugins: [Paragraph, Bold],
