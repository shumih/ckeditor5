...
describe('DropdownView', () => {
          ...
          it('uses _getOptimalPosition() and a dedicated set of positions (LTR)', () => {
            ...
            sinon.assert.calledWithExactly(
              ...
              sinon.match({
                ...
                positions: [southEast, southWest, northEast, northWest],
                fitInViewport: true,
              })
            );
          });
          ...
          it('uses _getOptimalPosition() and a dedicated set of positions (RTL)', () => {
            ...
            sinon.assert.calledWithExactly(
              ...
              sinon.match({
                element: panelView.element,
                target: buttonView.element,
                positions: [southWest, southEast, northWest, northEast],
                fitInViewport: true,
              })
            );
          });
  ...
  describe('render()', () => {
    it('starts listening for #keystrokes coming from #element', () => {
      const view = new DropdownView(locale, new ButtonView(locale), new DropdownPanelView(locale));
