...
BalloonPanelView.defaultPositions = {
  ...
  northWestArrowSouthMiddleWest: (targetRect, balloonRect) => ({
    top: getNorthTop(targetRect, balloonRect),
    left: targetRect.left - balloonRect.width * 0.25 - BalloonPanelView.arrowHorizontalOffset,
    name: 'arrow_smw',
  }),
  ...
  northWestArrowSouthMiddleEast: (targetRect, balloonRect) => ({
    top: getNorthTop(targetRect, balloonRect),
    left: targetRect.left - balloonRect.width * 0.75 + BalloonPanelView.arrowHorizontalOffset,
    name: 'arrow_sme',
  }),
  ...
  northEastArrowSouthMiddleWest: (targetRect, balloonRect) => ({
    top: getNorthTop(targetRect, balloonRect),
    left: targetRect.right - balloonRect.width * 0.25 - BalloonPanelView.arrowHorizontalOffset,
    name: 'arrow_smw',
  }),
  ...
  northEastArrowSouthMiddleEast: (targetRect, balloonRect) => ({
    top: getNorthTop(targetRect, balloonRect),
    left: targetRect.right - balloonRect.width * 0.75 + BalloonPanelView.arrowHorizontalOffset,
    name: 'arrow_sme',
  }),
