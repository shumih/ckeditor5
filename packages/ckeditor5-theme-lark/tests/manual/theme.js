...
function renderButton() {
  ...
  ui.buttonTypes.add(toolbar([actionButton, roundedButton, boldButton, saveButton, cancelButton]));
...
function renderToolbar() {
  ...
  ui.toolbarText.add(toolbar([icon(boldIcon), text()]));

  // --- Button ------------------------------------------------------------

  ui.toolbarButton.add(
    toolbar([
      button(),
      text(),
      button({
...
function input({ label = 'Labeled input', isReadOnly = false, value = 'The value of the input' } = {}) {
