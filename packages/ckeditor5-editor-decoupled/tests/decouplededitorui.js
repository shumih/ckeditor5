...
describe('DecoupledEditorUI', () => {
  ...
  describe('init()', () => {
    ...
    describe('editable', () => {
      ...
      it('binds view.editable#isFocused', () => {
        utils.assertBinding(view.editable, { isFocused: false }, [[ui.focusTracker, { isFocused: true }]], {
          isFocused: true,
        });
      });
    ...
    describe('placeholder', () => {
      it('sets placeholder from editor.config.placeholder', () => {
        return VirtualDecoupledTestEditor.create('foo', {
      ...
      it('sets placeholder from the "placeholder" attribute of a passed <textarea>', () => {
        ...
        return VirtualDecoupledTestEditor.create(element, {
          extraPlugins: [Paragraph],
        }).then(newEditor => {
          const firstChild = newEditor.editing.view.document.getRoot().getChild(0);
    ...
    it('initializes keyboard navigation between view#toolbar and view#editable', () => {
      return VirtualDecoupledTestEditor.create('').then(editor => {
        const ui = editor.ui;
        const view = ui.view;
  ...
  describe('destroy()', () => {
    ...
    it('restores the editor element back to its original state', () => {
      ...
      return VirtualDecoupledTestEditor.create(domElement).then(newEditor => {
        return newEditor.destroy().then(() => {
          const attributes = {};
      ...
      resolve(
        editor
          ...
          .then(() => {
            ...
            const initialData = isElement(sourceElementOrData) ? sourceElementOrData.innerHTML : sourceElementOrData;
