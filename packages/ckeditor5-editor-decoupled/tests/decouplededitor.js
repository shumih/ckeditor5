...
describe('DecoupledEditor', () => {
  ...
  describe('create()', () => {
        ...
        .then(
          ...
          err => {
            expect(err)
              ...
              .and// eslint-disable-next-line max-len
              .match(
    ...
    function test(getElementOrData) {
      it('creates an instance which inherits from the DecoupledEditor', () => {
        return DecoupledEditor.create(getElementOrData(), {
      ...
      it('should not require config object', () => {
        ...
        return CustomDecoupledEditor.create(getElementOrData()).then(newEditor => {
          expect(newEditor.getData()).to.equal('<p><strong>foo</strong> bar</p>');
      ...
      describe('events', () => {
        it('fires all events in the right order', () => {
          ...
          return DecoupledEditor.create(getElementOrData(), {
            ...
            expect(fired).to.deep.equal(['ready-decouplededitorui', 'ready-datacontroller', 'ready-decouplededitor']);
  ...
  describe('destroy', () => {
    describe('editor with data', () => {
      beforeEach(function() {
        return DecoupledEditor.create(editorData, { plugins: [Paragraph] }).then(newEditor => {
          editor = newEditor;
        });
      });
    ...
    describe('editor with editable element', () => {
      ...
      beforeEach(function() {
        ...
        return DecoupledEditor.create(editableElement, { plugins: [Paragraph] }).then(newEditor => {
          editor = newEditor;
        });
      });
