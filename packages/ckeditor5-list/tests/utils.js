  ...
  describe('createViewListItemElement()', () => {
    ...
    describe('getFillerOffset', () => {
      ...
      it('should return 0 if item has only lists as children', () => {
        ...
        writer.insert(writer.createPositionAt(innerListItem1, 0), writer.createText('foo'));

        const innerListItem2 = createViewListItemElement(writer);

        writer.insert(writer.createPositionAt(innerListItem2, 0), writer.createText('bar'));
      ...
      describe('for <br> elements in container', () => {
        ...
        it('empty element must be the <br> element', () => {
          ...
          writer.insert(writer.createPositionAt(item, 0), writer.createEmptyElement('img'));
