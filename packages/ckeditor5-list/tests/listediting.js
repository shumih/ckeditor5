...
describe('ListEditing', () => {
  ...
  describe('flat lists', () => {
    describe('setting data', () => {
      ...
      test(
        'mixed list and content #1',
        '<p>xxx</p><ul><li>a</li><li>b</li></ul><ol><li>c</li><li>d</li></ol><p>yyy</p>'
      );
      test(
        'mixed list and content #2',
        '<ol><li>a</li></ol><p>xxx</p><ul><li>b</li><li>c</li></ul><p>yyy</p><ul><li>d</li></ul>'
      );
      test(
        'clears incorrect elements',
        '<ul>x<li>a</li><li>b</li><p>xxx</p>x</ul><p>c</p>',
      ...
      // #ckeditor5/1399
      test(
        'single item with `font-weight` style',
        '<ol><li style="font-weight: bold">foo</li></ol>',
        '<ol><li><strong>foo</strong></li></ol>'
      );
      ...
      describe('block elements inside list items', () => {
        describe('single block', () => {
          test('single item', '<ul><li><p>Foo</p></li></ul>', '<p>Foo</p>');
          test('multiple items', '<ul><li><p>Foo</p></li><li><p>Bar</p></li></ul>', '<p>Foo</p><p>Bar</p>');
          test('nested items', '<ul><li><p>Foo</p><ol><li><p>Bar</p></li></ol></li></ul>', '<p>Foo</p><p>Bar</p>');
        });

        describe('multiple blocks', () => {
          test('single item', '<ul><li><h2>Foo</h2><p>Bar</p></li></ul>', '<p>Foo</p><p>Bar</p>');
          test(
            'multiple items',
        ...
        describe.skip('multiple blocks', () => {
          // Skip due to #112 issue.
          test(
            'nested items #1',
        ...
        describe('inline + block', () => {
          test('single item', '<ul><li>Foo<p>Bar</p></li></ul>', '<ul><li>Foo</li></ul><p>Bar</p>');
          test(
            'multiple items',
            '<ul><li>Foo<p>Bar</p></li><li>Foz<p>Baz</p></li></ul>',
            '<ul><li>Foo</li></ul><p>Bar</p><ul><li>Foz</li></ul><p>Baz</p>'
          );
          test('split by list items', '<ul><li>Foo</li><li><p>Bar</p></li></ul>', '<ul><li>Foo</li></ul><p>Bar</p>');
          test(
        ...
        describe('block + inline', () => {
          test('single item', '<ul><li><p>Foo</p>Bar</li></ul>', '<p>Foo</p><ul><li>Bar</li></ul>');
          test(
            'multiple items',
            '<ul><li><p>Foo</p>Bar</li><li><p>Foz</p>Baz</li></ul>',
            '<p>Foo</p><ul><li>Bar</li></ul><p>Foz</p><ul><li>Baz</li></ul>'
          );
          test('split by list items', '<ul><li><p>Bar</p><li>Foo</li></li></ul>', '<p>Bar</p><ul><li>Foo</li></ul>');
          test(
            'nested split by list items',
    ...
    describe('convert changes', () => {
      describe('insert', () => {
        ...
        testInsert(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '<li>x</li>' + '<li>b</li>' + '</ul>'
        );
        ...
        testInsert(
          ...
          '<p>p</p>' + '<ol>' + '<li>x</li>' + '</ol>' + '<ul>' + '<li>a</li>' + '</ul>'
        );
        ...
        testInsert(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '</ul>' + '<ol>' + '<li>x</li>' + '</ol>'
        );
        ...
        testInsert(
          ...
          '<ul>' + '<li>a</li>' + '</ul>' + '<p>x</p>' + '<ul>' + '<li>a</li>' + '</ul>'
        );
      });
      ...
      describe('remove', () => {
        ...
        testRemove(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '<li>b</li>' + '</ul>' + '<p>p</p>'
        );
        ...
        testRemove(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '</ul>' + '<ol>' + '<li>b</li>' + '</ol>' + '<p>p</p>'
        );
      });
      ...
      describe('change type', () => {
        testChangeType(
          ...
          '<p>p</p>' + '<ol>' + '<li>a</li>' + '</ol>' + '<ul>' + '<li>b</li>' + '<li>c</li>' + '</ul>'
        );
        ...
        testChangeType(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '<li>b</li>' + '</ul>' + '<ol>' + '<li>c</li>' + '</ol>'
        );
      ...
      describe('rename to list item (with attribute change)', () => {
        ...
        testRenameToListItem(
          'paragraph between paragraphs',
          0,

          '<paragraph>x</paragraph>' + '[<paragraph>a</paragraph>]' + '<paragraph>x</paragraph>',

          '<p>x</p>' + '<ul>' + '<li>a</li>' + '</ul>' + '<p>x</p>'
        );

        testRenameToListItem(
          'element before list of same type',
          0,

          '[<paragraph>x</paragraph>]' + '<listItem listIndent="0" listType="bulleted">a</listItem>',

          '<ul>' + '<li>x</li>' + '<li>a</li>' + '</ul>'
        );

        testRenameToListItem(
          'element after list of same type',
          0,

          '<listItem listIndent="0" listType="bulleted">a</listItem>' + '[<paragraph>x</paragraph>]',

          '<ul>' + '<li>a</li>' + '<li>x</li>' + '</ul>'
        );

        testRenameToListItem(
          'element before list of different type',
          0,

          '[<paragraph>x</paragraph>]' + '<listItem listIndent="0" listType="numbered">a</listItem>',

          '<ul>' + '<li>x</li>' + '</ul>' + '<ol>' + '<li>a</li>' + '</ol>'
        );

        testRenameToListItem(
          'element after list of different type',
          0,

          '<listItem listIndent="0" listType="numbered">a</listItem>' + '[<paragraph>x</paragraph>]',

          '<ol>' + '<li>a</li>' + '</ol>' + '<ul>' + '<li>x</li>' + '</ul>'
        );

        testRenameToListItem(
          'element between lists of same type',
          0,
      ...
      describe('move', () => {
        testMove(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '<li>c</li>' + '<li>b</li>' + '</ul>'
        );
        ...
        testMove(
          ...
          '<p>p</p>' + '<ul>' + '<li>a</li>' + '</ul>' + '<p>p</p>' + '<ul>' + '<li>b</li>' + '</ul>'
        );
        ...
        testMove(
          ...
          '<ul>' + '<li>a</li>' + '</ul>' + '<p>p</p>' + '<ul>' + '<li>c</li>' + '<li>b</li>' + '<li>d</li>' + '</ul>'
        );
  ...
  describe('nested lists', () => {
    describe('setting data', () => {
      ...
      test(
        'bullet list simple structure',
        '<p>foo</p>' + '<ul>' + '<li>' + '1' + '<ul>' + '<li>1.1</li>' + '</ul>' + '</li>' + '</ul>' + '<p>bar</p>'
      );

      test(
        'bullet list deep structure',
        '<p>foo</p>' +
          '<ul>' +
          '<li>' +
          '1' +
      ...
      test(
        'mixed lists deep structure, white spaces, incorrect content, empty items',
        '<p>foo</p>' +
        '<ul>' +
        '	xxx' +
        '	<li>' +
    ...
    describe('convert changes', () => {
      describe('insert', () => {
        describe('same list type', () => {
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>' + '1' + '<ul>' + '<li>x</li>' + '</ul>' + '</li>' + '</ul>'
          );
          ...
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>' + '1' + '<ul>' + '<li>x</li>' + '<li>1.1</li>' + '</ul>' + '</li>' + '</ul>'
          );
          ...
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>' + '1' + '<ul>' + '<li>x</li>' + '</ul>' + '</li>' + '<li>2</li>' + '</ul>'
          );
          ...
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>' + '1' + '<ul>' + '<li>1.1</li>' + '<li>x</li>' + '</ul>' + '</li>' + '</ul>'
          );
          ...
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>1</li>' + '<li>' + 'x' + '<ul>' + '<li>1.1</li>' + '</ul>' + '</li>' + '</ul>'
          );
        ...
        describe('different list type', () => {
          testInsert(
            ...
            '<p>p</p>' + '<ul>' + '<li>' + '1' + '<ol>' + '<li>x</li>' + '<li>1.1</li>' + '</ol>' + '</li>' + '</ul>'
          );
      ...
      describe('remove', () => {
        ...
        testRemove(
          ...
          '<ul>' + '<li>' + 'a' + '<ul>' + '<li>b</li>' + '<li>d</li>' + '</ul>' + '</li>' + '</ul>'
        );
        ...
        testRemove(
          ...
          '<ul>' + '<li>' + 'a' + '<ol>' + '<li>b</li>' + '<li>d</li>' + '</ol>' + '</li>' + '</ul>'
        );
        ...
        testRemove(
          ...
          '<ul>' + '<li>' + 'a' + '<ul>' + '<li>c</li>' + '<li>d</li>' + '</ul>' + '</li>' + '</ul>'
        );
      ...
      describe('change type', () => {
        ...
        testChangeType(
          ...
          '<ul>' + '<li>' + 'a' + '<ol>' + '<li>b</li>' + '<li>c</li>' + '<li>d</li>' + '</ol>' + '</li>' + '</ul>'
        );
      });
      ...
      describe('change indent', () => {
        describe('same list type', () => {
          ...
          testChangeIndent(
            'indent middle item of flat list',
            1,
          ...
          testChangeIndent(
            'indent last item in nested list',
            2,
          ...
          testChangeIndent(
            'indent middle item in nested list',
            2,
          ...
          testChangeIndent(
            'indent item that has nested list',
            1,
          ...
          testChangeIndent(
            'indent item that in view is a next sibling of item that has nested list',
            1,
          ...
          testChangeIndent(
            'outdent the first item of nested list',
            0,
          ...
          testChangeIndent(
            'outdent item from the middle of nested list',
            0,
          ...
          testChangeIndent(
            'outdent the last item of nested list',
            0,
          ...
          testChangeIndent(
            'outdent the only item of nested list',
            1,
          ...
          testChangeIndent(
            ...
            '<ul>' + '<li>' + 'a' + '<ul>' + '<li>b</li>' + '</ul>' + '</li>' + '<li>c</li>' + '<li>d</li>' + '</ul>'
          );
        });
      ...
      describe('rename to list item (with attribute change)', () => {
        testRenameToListItem(
          'element into first item in nested list',
          1,

          '<listItem listIndent="0" listType="bulleted">a</listItem>' + '[<paragraph>b</paragraph>]',

          '<ul>' + '<li>' + 'a' + '<ul>' + '<li>b</li>' + '</ul>' + '</li>' + '</ul>'
        );

        testRenameToListItem(
          'element into last item in nested list',
          1,
        ...
        testRenameToListItem(
          'element into a first item in deeply nested list',
          2,
  ...
  describe('paste and insertContent integration', () => {
    ...
    it('should create correct model when list items are pasted in non-list context', () => {
      setModelData(model, '<paragraph>A[]</paragraph>' + '<paragraph>B</paragraph>');
  ...
  describe('other', () => {
    ...
    it('ul and ol should not be inserted before ui element - injectViewList()', () => {
      ...
      expect(getViewData(editor.editing.view, { withoutSelection: true })).to.equal(
        '<ul><li>Foo<span></span></li><li>Bar</li></ul>'
      );
      ...
      expect(getViewData(editor.editing.view, { withoutSelection: true })).to.equal(
        '<ul><li>Foo<span></span><ul><li>Bar</li></ul></li></ul>'
      );
    });
    ...
    it('ul and ol should not be inserted before ui element - hoistNestedLists()', () => {
      ...
      expect(getViewData(editor.editing.view, { withoutSelection: true })).to.equal(
        '<ul><li>Foo<span></span></li><li>Bar<ul><li>Xxx</li><li>Yyy</li></ul></li></ul>'
      );
      ...
      expect(getViewData(editor.editing.view, { withoutSelection: true })).to.equal(
        '<ul><li>Foo<span></span><ul><li>Xxx</li><li>Yyy</li></ul></li></ul>'
      );
    });
  ...
  describe('schema checking and parent splitting', () => {
    ...
    it('should split parent element when one of modelCursor ancestors allows to insert list - in the middle', () => {
      ...
      editor.setData('<div>' + 'abc' + '<ul>' + '<li>foo</li>' + '</ul>' + 'def' + '</div>');

      expect(getModelData(model, { withoutSelection: true })).to.equal(
        '<div>abc</div>' + '<listItem listIndent="0" listType="bulleted">foo</listItem>' + '<div>def</div>'
      );
    });
    ...
    it('should split parent element when one of modelCursor ancestors allows to insert list - at the end', () => {
      ...
      editor.setData('<div>' + 'abc' + '<ul>' + '<li>foo</li>' + '</ul>' + '</div>');

      expect(getModelData(model, { withoutSelection: true })).to.equal(
        '<div>abc</div>' + '<listItem listIndent="0" listType="bulleted">foo</listItem>'
      );
    });
    ...
    it('should split parent element when one of modelCursor ancestors allows to insert list - at the beginning', () => {
      ...
      editor.setData('<div>' + '<ul>' + '<li>foo</li>' + '</ul>' + 'def' + '</div>');

      expect(getModelData(model, { withoutSelection: true })).to.equal(
        '<listItem listIndent="0" listType="bulleted">foo</listItem>' + '<div>def</div>'
      );
    });

    // https://github.com/ckeditor/ckeditor5-list/issues/121
    it('should correctly set data.modelCursor', () => {
      editor.setData('<ul>' + '<li>a</li>' + '<li>b</li>' + '</ul>' + 'c');
